   ...
   var RepGRNPrintFormPannel = new Ext.FormPanel({
	...
	bodyStyle   :{"background-color":"#F1F5EA"},
        ...
        tbar: { 
			...
			{
			var grnno=Ext.getCmp('cmbgrnno').getRawValue();
			var d2='M';
...
window.open('http://192.168.11.14:8080/birt/frameset?__report=Fuel/RepFuGRN.rptdesign' + param); 
...
{ 
    ...
    var RepGRNprintWindow = new Ext.Window({
	height      : 200,
        width       : 440,
        y           : 35,
        title       : 'GRN Print',
