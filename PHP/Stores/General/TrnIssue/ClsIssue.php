...
else
{
 $irtype = "R";
        ...
        $sql = "select ifnull(max(iss_no),0) + 1 as issno from trnpur_item_issues where iss_comp_code=$compcode and iss_fin_code=$finid and iss_type = '$irtype'";
*/
        $sql = "select ifnull(max(iss_no),0) + 1 as issno from trnpur_item_issues where iss_comp_code=$compcode and iss_fin_code=$finid and iss_type = '$isstype'";
