...
//      autoLoad :true,
      proxy: new Ext.data.HttpProxy({
            ...
            baseParams:{task:"loadDCnolist_Pending"}, // this parameter asks for listing
      reader: new Ext.data.JsonReader({
                  // we tell the datastore where to get his data from
        root: 'results',
        totalProperty: 'total',
...
//      autoLoad :true,
 ...
 'dcr_date', 'dcr_party', 'dcr_dcno', 'dcr_dcdate', 'dcr_dcfincode', 'dcr_truck', 'dcr_freight_type', 'dcr_freight', 'dcr_itemcode', 'dcr_newitemcode', 'dcr_recd_qty', 'dcr_purpose', 'dcr_remaks', 'dct_item_code', 'dct_issqty', 'dct_recqty', 'dct_rate', 'dct_purpose', 'dct_hsncode','item_name' , 'uom_short_name','dch_date', 'dch_party', 'dch_dept','dch_no','dcr_inwardno', 'dcr_inwarddate', 'dcr_slno'
      ]),
    });
					   ...
					   txtFreight.setValue(loadDCrecptnodetaildatastore.getAt(0).get('dcr_freight'));
		                              ...
		                              flxDetail.getStore().insert(
		                                  ...
		                                  new dgrecord({
                                                  ...
                                                  itemname  :loadDCrecptnodetaildatastore.getAt(j).get('item_name'), //
