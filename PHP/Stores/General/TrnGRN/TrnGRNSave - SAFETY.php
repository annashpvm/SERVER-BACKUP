...
'$minhcompcode','$minhfincode','$minhvoutype','$minhtype', '$minhminno' ,'$minhmindate', '$minhsupcode', '$minhbillno', '$minhbilldate', '$minhgrossvalue', '$minhroundoff','$roundneed', '$minhvalue', '$minhcarrier','$minhremarks', '$minhentdate','$minhcreditdays', '$minhgeno', '$minhgedate', '$minhlrno', '$minhlrdate', '$minhvouno', 'Y', '$ginaccrefseq' ,'$minhmindate','$tcsauto','$minhcgstpm','$minhsgstpm','$minhigstpm','$minhtottcs')";
...
//echo "<br>";
    ...
    $query2="call sppur_upd_minheader('$minhvoutype','$minhcompcode','$minhminno','$minhmindate','$minhfincode','$minhbillno','$minhbilldate' ,'$minhgrossvalue', '$minhroundoff','$roundneed','$minhvalue','$minhcarrier','$minhremarks','$minhcreditdays','$minhgeno','$minhgedate','$minhlrno','$minhlrdate','$tcsauto','$minhcgstpm','$minhsgstpm','$minhigstpm','$minhtottcs')";
//echo $query2;
    $result2=mysql_query($query2);
}
...
for ($i=0;$i<$rowcnt;$i++){
	...
	$mintindno =$griddet[$i]['mintindentno'];
	...
	if ($savetype == "Add") {
	 ...
	 $query4= "insert into  trnpur_min_trailer values('$minhcompcode', '$minhfincode','$minhvoutype','$minhminno', '$minhmindate', '$minhsupcode','$mintpono', '$mintpodate', '$mintindno', '$mintindfincode','$mintslno', '$mintitemcode', '$mintinvqty', '$mintrcvdqty', '$mintacceptqty', '$mintrejqty', '$mintunitrate', '$mintcostrate', '$mintpfper','$mintothers' ,'$mintfreight' , '$mintdiscount', '$mintotherpm' , '$mintvalue','$mintqcstatus', '$mintcrstatus', '$mintdisamt', '$mintpfamt', '$mintcgstper', '$mintcgstamt', '$mintsgstper' , '$mintsgstamt' , '$mintigstper','$mintigstamt',   '$minttcsper', '$minttcsval','$mintrebate','$purgrpcode','$cgstled','$sgstled','$igstled')";
...
//echo "<br>";
	...
	$query4 = "call sppur_upd_mintrailer('$minhvoutype','$minhcompcode','$minhminno','$minhmindate','$minhfincode','$mintpono','$mintpodate','$minhsupcode', '$mintitemcode','$mintinvqty','$mintrcvdqty','$mintacceptqty','$mintrejqty','$mintunitrate','$mintcostrate','$mintpfper','$mintothers','$mintfreight', '$mintdiscount','$mintotherpm','$mintvalue','$mintindfincode','$mintindno','$mintcrstatus','$mintslno','$mintdisamt','$mintpfamt', '$mintcgstper','$mintcgstamt','$mintsgstper','$mintsgstamt','$mintigstper','$mintigstamt','$minttcsper','$minttcsval','$mintrebate','$purgrpcode','$cgstled','$sgstled','$igstled')";
...
$rowcntacc = $_REQUEST['cntacc'];
        ...
        for($i=0;$i<$rowcntacc;$i++){
            ...
            #Insert AccTrail
               if ($ledtype != 'G')
               {
               $querya2 = "call acc_sp_trn_insacc_trail ('$ginaccrefseq','$slno','$minhbillno', '$minhbilldate', '$totamt' ,'$adjamt' ,'$ledseq' ,'$amtmode','0','0')";
               $resulta2 = mysql_query($querya2);
//echo  $querya2;
//echo "<br>";
