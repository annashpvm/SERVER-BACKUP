...
else
{
 $irtype = "R";
        ...
        $sql = "call sp_pur_issue_details_new($compcode,$finid,$issno,'$irtype')");
    $r = mysqli_query($conn, $sql);
...
function getindent()
	...
	$procurstk = $_POST['procurstk'];
        ...
        $sql = "select ind_no,ind_fin_code from trnpur_indent where ind_comp_code = $compcode and ind_fin_code = $finid and ind_dept_code = $deptcode and ind_option = '$procurstk'  group by ind_no,ind_fin_code order by ind_no desc");
    $r = mysqli_query($conn, $sql);
