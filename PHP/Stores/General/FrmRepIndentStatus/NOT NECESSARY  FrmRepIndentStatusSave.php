...
else
{
	...
	$result2=mysql_query($query2);      
        ...
        $query3= "update trnpur_indent set ind_iss_qty = ind_iss_qty  -	 $oldqty ,ind_bal_qty = ind_bal_qty +  $oldqty  where Ind_no = $issindno  AND ind_comp_code = $isscompcode and ind_fin_code = $issindfincode and ind_item_code = $issitemcode ";
