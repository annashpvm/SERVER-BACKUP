...
//        $sql = "select hsn_code,hsn_sno from mas_hsncode order by hsn_code";
 ...
 function getitemDetail()
	...
	$compcode = $_POST['compcode'];
        ...
        $sql = "select *  from maspur_item_header h,maspur_item_trailer t , maspur_subgroup sg  , maspur_group mg , mas_uom u where  item_group_code = subgrp_code and subgrp_grpcode = grp_code and uom_code = item_uom and
 ...
 function getLocation()
    {
        ...
        $sql = "select * from maspur_location order by loc_name";
...
*/
        $sql = "call spst_rep_stock_item_Month_Abstract($compcode ,$finid,$item)";
 ...
 function getItemLedger()
	...
	$startdate = $_POST['startdate'];
        ...
        $sql="call sp_pur_rep_storeledger_item($compcode ,'$finid', '$item','$startdate' ,'$enddate' )"; 
