...
function getsupplier(){
 ...
 function getgrnno()
	...
	$compcode = $_POST['compcode'];
        $sql = "select IFNULL(max(wogh_no),0)+1 as wogh_no from trnpur_wogrn_header where wogh_fin_code = $finid and wogh_comp_code=$compcode";
 ...
 function getwogrnlist()
	...
	$finid = $_POST['finid'];
	$compcode = $_POST['compcode'];
        $sql = "select wogh_no from trnpur_wogrn_header where wogh_fin_code = $finid and wogh_comp_code=$compcode order by wogh_no desc";
    $r = mysqli_query($conn, $sql);
 ...
 $sql = "select * from trnpur_wogrn_header, trnpur_wogrn_trailer,mas_item_master, mas_workorder  where  wo_no = wogh_wono and item_code = wogt_itemcode and wogh_comp_code = wogt_comp_code and wogh_fin_code = wogt_fin_code  and wogh_no = wogt_no and wogh_comp_code = $compcode  and wogh_fin_code = $finid  and wogh_no = $wogrnno";
...
{	$sql = "select woh_no as genh_no from trnpur_workorder_header , trnpur_workorder_trailer where woh_seqno = wot_hdseqno and woh_sup_code = $supcode and woh_comp_code = $compcode and woh_fin_code = $finid  and wot_qty > wot_recd  group by woh_no  order by woh_no desc";
}
...
{
$sql = "select woh_no as gent_pono ,woh_dept as genh_dept , woh_seqno from trnpur_workorder_header , trnpur_workorder_trailer where woh_seqno = wot_hdseqno and woh_sup_code = $supcode and woh_comp_code = $compcode and woh_fin_code = $finid  and wot_qty > wot_recd  group by woh_no,woh_dept  order by woh_no,woh_dept desc";
...
function getwono2()
	...
	$sql = "select woh_no from trnpur_workorder_header , trnpur_workorder_trailer where woh_seqno = wot_hdseqno and woh_sup_code = $supcode and woh_comp_code = $compcode and woh_fin_code = $finid  and wot_qty > wot_recd  group by woh_no  order by woh_no desc";
    $r = mysqli_query($conn, $sql);
...
$sql = "select item_name,wot_itemcode,woh_date,wo_name,wo_no,dept_name,dept_code,woh_frt_party1,woh_frt_party2,woh_frt_amt1,woh_frt_amt2,
