...
function datecheck()
  {
        ...
        if (diffdays == 0 || diffdays == 1)  
        {
			...
			params: {
			    ...
			    fincode  : GinFinid,
			    compcode : Gincompcode,
                            repdate : Ext.util.Format.date(dtsales.getValue(),"Y-m-d"),
  		        },
                      	callback:function()
                        {
...
//alert(txtSalesInvNo.getValue());
			...
			{   
		        		   ...
		        		   buttons: Ext.MessageBox.YESNO,
		                           msg: 'Are You sure Want to Cancel this Invoice',
		                    	   fn: function(btn)
					   {         
					      if (btn == 'yes')
			                      { 
      					       ...
      					       var finupdData = new Array();
                                               ...
                                               Ext.Ajax.request({
				               url: 'TrnOtherSalesSaveCancel.php',
				               params:
						{
						...
						{    
	                                    ...
	                                    Ext.MessageBox.alert("Other Sales Invoice Cancelled -" + obj['saleno']);
