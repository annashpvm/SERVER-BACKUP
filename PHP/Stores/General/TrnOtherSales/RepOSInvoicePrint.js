...
//alert(invprttype);
		...
		window.open('http://10.0.0.251:8080/birt/frameset?__report=Stores/RptOtherSalesEinv.rptdesign&__format=pdf&' + param, '_blank');
				      ...
				      var param = (p1 + p2 + p3 + p4 );   
                                      ...
                                      if (invtype == "E")  
				      window.open('http://10.0.0.251:8080/birt/frameset?__report=Stores/RptOtherSalesEinv.rptdesign&__format=pdf'+ param);
                                      else
					      ...
					      var param = (p1 + p2 + p3  + p4 ); 
                                                if (invtype == "E")     
					      window.open('http://10.0.0.251:8080/birt/frameset?__report=Stores/RptOtherSalesEinv.rptdesign&__format=pdf&__format=pdf'+ param); 
                                               else
			                          window.open('http://10.0.0.251:8080/birt/frameset?__report=Stores/RptOtherSalesInvoice.rptdesign&__format=pdf'+ param); 
