...
//      autoLoad : true,
      ...
      reader: new Ext.data.JsonReader({
        ...
        id: 'id'
          ...
          'cust_code', 'cust_name','cust_gstin','cust_state','cust_code'
...
'salitem_cgstper', 'salitem_sgstper','salitem_igstper','salitem_salesledcode_tn', 'salitem_salesledcode_os', 'salitem_cgstledcode', 'salitem_sgstledcode',  'salitem_igstledcode', 'tn_sal_ledger','os_sal_ledger', 'cgst_ledger', 'sgst_ledger', 'igst_ledger', 'os_seqno', 'os_rounding','cust_name','cust_gst_type',
 'U_TCSStatus','U_EWBStatus','E_inv_confirm','U_ReUpload','U_AckNo','U_EWayBillNo'
...
//				scope: this,
					   ...
					   txtpartyref.setValue(LoadsaleinvnoDetailDatastore.getAt(0).get('os_partyref'));
 				              ...
 				              saleslcode = LoadsaleinvnoDetailDatastore.getAt(0).get('salitem_salesledcode_tn');
                                         ...
                                         if (LoadsaleinvnoDetailDatastore.getAt(0).get('E_inv_confirm') == "Y")
                                         {
...
specialkey:function(f,e){
        ...
        select:function(){
			LoadCustomerDetailDatastore.load({
                        url: 'ClsOthSales.php',
                        params:
                            {
                                task:"loadgstno",
				...
				callback:function(){
				custstate   = LoadCustomerDetailDatastore.getAt(0).get('cust_state');
				custledcode = LoadCustomerDetailDatastore.getAt(0).get('cust_code');
				txtGSTIN.setValue(LoadCustomerDetailDatastore.getAt(0).get('cust_gstin'));
        	        	}
                        });         
        }
    }
