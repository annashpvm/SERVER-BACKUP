...
//TCS Account - Debit
		...
		flxAccounts.getStore().insert(
		  ...
		  new dgrecord({
		      ...
		      debit     : Ext.util.Format.number(txtTCSValue.getRawValue(),'0.00'), 
		      credit    : 0,
                      ledtype   : "G",
                      billno    : txtBillno.getRawValue(),
                      billdt    : Ext.util.Format.date(dtpBillDate.getValue(),"Y-m-d"),
...
//CESS Account - Debit
		...
		flxAccounts.getStore().insert(
		  ...
		  new dgrecord({
		      ...
		      debit     : Ext.util.Format.number(txtCessValue.getRawValue(),'0.00'), 
		      credit    : 0,
              billno    : txtBillno.getRawValue(),
              billdt    : Ext.util.Format.date(dtpBillDate.getValue(),"Y-m-d"),
                      ledtype   : "G",
...
//HANDLING Account - Debit
		...
		flxAccounts.getStore().insert(
		  ...
		  new dgrecord({
		      ...
		      debit     : Ext.util.Format.number(txtHandCharges.getRawValue(),'0.00'),  
		      credit    : 0,
              billno    : txtBillno.getRawValue(),
              billdt    : Ext.util.Format.date(dtpBillDate.getValue(),"Y-m-d"),
                      ledtype   : "G",
...
//			txtGRNWt.setRawValue(Ext.util.Format.number(loadCheck_QC_TicketNoDatastore.getAt(0).get('qc_fuel_acceptqty')/1000,"0.000"));
                        ...
                        grnitemcode = loadCheck_QC_TicketNoDatastore.getAt(0).get('qc_fuel_itemcode');
...
;
			...
			txtHandlingsgst.setValue('9');
		                if (loadCheck_QC_TicketNoDatastore.getAt(0).get('cust_taxtag') == 1) 	
		                    ...
		                    cmbPurchaseLedger.setValue(2664);
		        }
                        else if (grnitemcode == 9)
                        {
                        cmbPurchaseLedger.setValue(1746);
                        }                        
  
                        else 
                        {
                        cmbPurchaseLedger.setValue(1745);
                        }                        
