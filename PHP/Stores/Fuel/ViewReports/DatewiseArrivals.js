        ...
        listeners: {
		    ...
		    var p5 = "&partycode="+encodeURIComponent(repparty);
 		    var param = (p1+p2+p3+p4+p5) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelDate_Party_GRNwiseArrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelDate_Party_GRNwiseArrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelDate_Party_GRNwiseArrivals.rptdesign' + param, '_blank');		
                }
            }
