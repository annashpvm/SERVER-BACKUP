...
var Issdetaildatastore = new Ext.data.Store({
  ...
  reader: new Ext.data.JsonReader({
    ...
    'isst_hdseqno', 'isst_seqno', 'isst_itmcode',  'isst_qty', 'isst_rate',  'isst_values', 'issh_type', 'issh_date', 'issh_seqno', 'itmh_name', 'itmt_clqty','isst_varty'
  ])
});
...
//alert(txtissqty.getValue());
//alert(txtstock.getValue());
