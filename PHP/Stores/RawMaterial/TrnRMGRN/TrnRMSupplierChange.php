...
//QC
$query4  = "update trn_qc_rm_inspection  set qc_rm_supcode = '$newsupcode' where qc_rm_entryno = '$qcinsno' and qc_rm_fincode = '$finid' and qc_rm_compcode = '$compcode'";
...
if ($dnaccseqno > 0) // for Debite Note
{

	$query6  = "update acc_tran set acctran_led_code = '$newsupcode'  where acctran_accref_seqno ='$dnaccseqno' and acctran_led_code='$oldsupcode'";
	$result6 = mysqli_query($conn, $query6);
//	echo $query6;
//	echo "<br>";	
	
	$query7  = "update acc_trail set acctrail_led_code = '$newsupcode'  where acctrail_accref_seqno ='$dnaccseqno' and acctrail_led_code='$oldsupcode'";
	$result7 = mysqli_query($conn, $query7);
//	echo $query7;
//	echo "<br>";	

   $query8  = "update acc_dbcrnote_header set dbcr_partycode = '$newsupcode'  ,  dbcr_partyledcode = '$newsupcode'   where dbcr_seqno ='$dnaccseqno' and  dbcr_comp_code = $compcode and dbcr_finid = $finid ";
