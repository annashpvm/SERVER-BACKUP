...
//sel[i].set('billrate', 0);   
          ...
          else
          {
           ...
           var valuex = Number(sel[i].data.itemrate) * Number(sel[i].data.grnqty);

//alert(Number(sel[i].data.grnqty));
          valuex = Math.round(Number(valuex)  * 10000) / 10000;
          valuex = Math.round((valuex +0.0001+ Number.EPSILON) * 100) / 100;
          value1 = valuex.toFixed(2);  


          var valuey = Number(sel[i].data.billrate) * Number(sel[i].data.billwt);



          valuey = Math.round(Number(valuey)  * 10000) / 10000;
          valuey = Math.round((valuey +0.0001+ Number.EPSILON) * 100) / 100;
          value2 = valuey.toFixed(2);  
    ...
    //      value3 = Number(value1) -  Number(value2) + Number(ratediff);
          ...
          value3 = Number(value2) -  Number(value1) ;


          value3 = Math.round((value3 +0.0001+ Number.EPSILON) * 100) / 100;
...
//          else
             ...
             value4 = Number(value3);

          value4 = Math.round((value4 +0.0001+ Number.EPSILON) * 100) / 100;
    ...
    console.log('Item:', sel[i].data);
    console.log('Setting itemdiffval to:', value3);

    if (!isNaN(value3)) {
        sel[i].set('itemdiffval', value3);
        sel[i].commit();  // Commit the change to the record
    } else {
        console.log('Invalid value for itemdiffval:', value3);
    }




          value4 =  Ext.util.Format.number(value4,'0.00');
          sel[i].set('itemdiffvalue', value4);
	...
	txtQCShortQty.setValue(Ext.util.Format.number(Number(qcshortqty)/1000,"0.000"));
...
if ( grnDate && grnDate  >  cutoffDate) {
        ...
        { 
            ...
            shortqty = Number(partybillqty) -  (Number(tickwt) - Number(degqty)) - Number(txtQCShortQty.getValue()) ;
...
//alert("less");
        ...
        ItemDiffValue = Math.abs(ItemDiffValue) - Number(shortvalue);
...
// New Changes on 20/06/2025 - End
	...
	txtWTShortageValue.setRawValue(Ext.util.Format.number(Number(shortvalue),"0.00"));
        txtRateDiffValue.setRawValue(Ext.util.Format.number(Number(rateValueDiff),"0.00"));
            ...
            qctaxamt = Number(txtWTShortageValue.getValue()) + Number(txtRateDiffValue.getValue()) + Number(txtTotalItemDiffValue.getValue()) ;

            qctaxamt = parseFloat(qctaxamt.toFixed(2));



 
        txtTotalDiffValue.setRawValue(Ext.util.Format.number(Number(qctaxamt),"0.00")); 
...
*/
      ...
      //  {header: "Short Value", dataIndex: 'shortagevalue',sortable:true,width:80,align:'left'},
        ...
        {header: "Diff Value", dataIndex: 'itemdiffval',sortable:true,width:80,align:'left'},
        {header: "Diff Value", dataIndex: 'itemdiffvalue',sortable:true,width:80,align:'left'},
    ],
    store: [],
    listeners:{	
