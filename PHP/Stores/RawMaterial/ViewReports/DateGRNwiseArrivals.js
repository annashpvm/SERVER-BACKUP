...
style: {
   ...
   var txtAllPartyPurchaseValue = new Ext.form.NumberField({
    ...
    var btnImportGRNwisePrint = new Ext.Button({
        style: 'text-align:center;',
        text: "IMPORT GRN",
        width: 100,
        id: 'btnImportGRNwisePrint',
	border: 1,
	style: {
	borderColor: 'blue',
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    var p1 ="&compcode="+encodeURIComponent(Gincompcode); 
 		    ...
 		    var param = (p1+p2+p3+p4) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDailyArrivalsImport.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDailyArrivalsImport.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDailyArrivalsImport.rptdesign' + param, '_blank');		
                }
            }
...
var optGRNtype = new Ext.form.FieldSet({
    xtype: 'fieldset',
    title: '',
    fieldLabel: '',
    layout : 'hbox',
    ...
    items: [
    {
        ...
        id: 'optGRNtype',
        items: [
		{boxLabel: 'ALL', name: 'optGRNtype', id:'allGRN', inputValue: 1,checked:true,
			listeners:{
		...
		{boxLabel: 'Local', name: 'optGRNtype', id:'optLocal', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						GRNType = "Local";
		...
		{boxLabel: 'Import', name: 'optGRNtype', id:'optImport', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
 						GRNType = "Import";
