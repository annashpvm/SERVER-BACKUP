...
var btnProcess = new Ext.Button({
	...
	borderStyle: 'solid',
		...
		var rtype = "&ptype=" + encodeURIComponent(1);
		...
		window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQtyStockAbs.rptdesign&__format=XLS&' + param, '_blank'); 
    ...
    var btnGroupWisePrint = new Ext.Button({
        style: 'text-align:center;',
        text: "Stock List-2",
        width: 80,
        id: 'btnGroupWisePrint',
	border: 1,
	style: {
	borderColor: 'blue',
	borderStyle: 'solid',
		...
		var rtype = "&ptype=" + encodeURIComponent(1);
	    	var param =(compcode+finid+p1+p2);
                ...
                if (printtype == "PDF") 
		window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQtyStockGroupAbs.rptdesign&__format=pdf&' + param, '_blank'); 

                else if (printtype == "XLS") 
		window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQtyStockGroupAbs.rptdesign&__format=XLS&' + param, '_blank'); 

                else  
		window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQtyStockGroupAbs.rptdesign&' + param, '_blank'); 
            }
        }
    });
