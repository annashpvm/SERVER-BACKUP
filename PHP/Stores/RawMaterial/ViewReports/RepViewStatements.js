...
var purtype = "ALL";
var optPurtype = new Ext.form.FieldSet({
    xtype: 'fieldset',
    title: '',
    fieldLabel: '',
    layout : 'hbox',
    ...
    items: [
    {
        ...
        id: 'optPurtype',
        items: [
		{boxLabel: 'ALL', name: 'optPurtype', id:'purAll', inputValue: 1,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
					    purtype = "ALL";
		...
		{boxLabel: 'Local', name: 'optPurtype', id:'optLocal', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						purtype="Local";
		...
		{boxLabel: 'Import', name: 'optPurtype', id:'optImport', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						purtype="Import";
    ...
    var btnRatewisePrint = new Ext.Button({
        style: 'text-align:center;',
        text: "Rate wise",
        width: 100,
        id: 'btnRatewisePrint',
 ...
 if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_Party_Item_RatewiseArrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_Party_Item_RatewiseArrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_Party_Item_RatewiseArrivals.rptdesign' + param, '_blank');
...
function grid_tot_Allgrn(){
       ...
       for(var i=0;i<Row;i++)

        {
         ...
         txtAllPartyPurchaseQty.setValue(pqty);
         txtAllPartyPurchaseValue.setValue(pvalue);
...
var flxMonth = new Ext.grid.EditorGridPanel({
    ...
    [ 	 	
        ...
        {header: "GRN - Qty"  , dataIndex: 'grnqty',sortable:false,width:130,align:'right', menuDisabled: true},
        {header: "Pur.-Value"  , dataIndex: 'purvalue',sortable:false,width:150,align:'right', menuDisabled: true},
    ],
...
var btnProcess = new Ext.Button({
    ...
    var btnAreaMonthwisePrint = new Ext.Button({
        style: 'text-align:center;',
        text: "Area-Monthwise",
        width: 100,
        id: 'btnAreaMonthwisePrint',
	border: 1,
	style: {
	borderColor: 'blue',
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    var p4 = "&itemcode="+encodeURIComponent(0);
 		    ...
 		    var param = (p1+p2+p3) ;
 if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMArea_Party_Monthwise_Arrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMArea_Party_Monthwise_Arrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMArea_Party_Monthwise_Arrivals.rptdesign' + param, '_blank');		
                  /*  if (printtype == "PDF") 
    ...
    var btnPartyMonthwisePrint = new Ext.Button({
        style: 'text-align:center;',
        text: "Party Monthwise",
        width: 100,
        id: 'btnPartyMonthwisePrint',
	border: 1,
	style: {
	borderColor: 'blue',
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    var p4 = "&purtype="+encodeURIComponent(purtype);
 		    ...
 		    var param = (p1+p2+p3+p4) ;
 if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMParty_Item_Monthwise_Arrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMParty_Item_Monthwise_Arrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMParty_Item_Monthwise_Arrivals.rptdesign' + param, '_blank');		
                  /*  if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_PartywiseArrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_PartywiseArrivals.rptdesign' + param, '_blank');*/		
...
var flxParty = new Ext.grid.EditorGridPanel({
    ...
    [ 	 	
        ...
        {header: "Value" , dataIndex: 'purvalue',sortable:false,width:130,align:'right', menuDisabled: true},
    ],
...
//			layout  : 'hbox',
    ...
    {    
		...
		},
		{
		    ...
		    width       : 120,
                    labelWidth  : 50,
		    items : [btnRatewisePrint]
		},
        ],
    }  ,
    {    
        xtype: 'panel',
        title: 'GRN - ITEM WISE ARRIVALS',
        bodyStyle: {"background-color": "#ffe6f7"},
        layout: 'absolute',
        items: [
