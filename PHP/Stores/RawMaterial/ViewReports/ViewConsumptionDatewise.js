...
//var excelfile =    *d:\rptDatewiseSales.xls*;
		...
		var p4 = "&option=" + encodeURIComponent(2);
                ...
                if (printtype == "PDF")
          	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDatewiseConsumption.rptdesign&__format=pdf&' + param, '_blank');
                else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDatewiseConsumption.rptdesign&__format=XLS' + param, '_blank');
}
                else
        	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMDatewiseConsumption.rptdesign' + param, '_blank');
...
var btnQlywiseAbstract = new Ext.Button({
...
//var excelfile =    *d:\rptDatewiseSales.xls*;
		...
		var p4 = "&option=" + encodeURIComponent(2);
                ...
                var param = (p1+p2+p3+p4) ;
                if (printtype == "PDF")
          	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQlywiseConsumption.rptdesign&__format=pdf&' + param, '_blank');
                else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQlywiseConsumption.rptdesign&__format=XLS' + param, '_blank');
}
                else
        	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMQlywiseConsumption.rptdesign' + param, '_blank');
...
//var excelfile =    *d:\rptDatewiseSales.xls*;
		...
		var p4 = "&option=" + encodeURIComponent(2);
                ...
                var param = (p1+p2+p3+p4) ;
                if (printtype == "PDF")
          	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMItemwiseConsumption.rptdesign&__format=pdf&' + param, '_blank');
                else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMItemwiseConsumption.rptdesign&__format=XLS' + param, '_blank');
}
                else
        	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMItemwiseConsumption.rptdesign' + param, '_blank');
...
function grid_tot_Date(){
 ...
 var loadDayConsumptionDataStore = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },['vargrp_type_name', 'itmh_name', 'qty', 'value' ]),
    });
...
var flxDateConsumptionList = new Ext.grid.EditorGridPanel({
    ...
    columns:
    [ 	 	
        {header: " Quality"    ,  dataIndex: 'vargrp_type_name',sortable:false,width:200,align:'left', menuDisabled: true },
