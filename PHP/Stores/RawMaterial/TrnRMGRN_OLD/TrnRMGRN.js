 ...
 var loadSearchLedgerListDatastore = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        id: 'id'
          ...
          'cust_code', 'cust_name','qc_rm_supcode', 'cust_state','cust_wp_gstinv_supplier_yn' 
      ]),
    });
...
'areagrp_code', 'areagrp_name','tax_purcode','tax_purname','tax_cgstper', 'tax_sgstper', 'tax_igstper', 'tax_cgstledcode', 'tax_sgstledcode', 'tax_igstledcode', 'tax_cgstledger', 'tax_sgstledger', 'tax_igstledger', 'tax_gst', 'tax_purtype', 'tax_state','qc_rm_millboard'
      ]),
...
var cmbGRNNo = new Ext.form.ComboBox({
	...
	//	flxitem.getStore().removeAll();
		...
		loadPurchaseGroupDatasore.load({
			...
			if(loadgrndetaildatastore.getAt(0).get('acctrail_adj_value') > 0){
...
var optTCSRounding = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        items: [
            ...
            {boxLabel: 'Not Needed', name: 'optTCSRounding', id:'TCSRoundNoNeed',  inputValue: 2,checked:true,
            listeners:{
            check:function(rb,checked){
            if(checked==true){
                tcsRound ="N";
   ...
   grid_tot(); 
            ...
            {boxLabel: 'Needed', name: 'optTCSRounding', id:'TCSRoundNeed',  inputValue: 1,
            listeners:{
            check:function(rb,checked){
            if(checked==true){
                 tcsRound ="Y";
