<?php
 ...
 function getsupplier()
	...
	$sql = "select sup_code,sup_refname from maspur_supplier_master  where sup_acc_group = '184' order by sup_refname");
 ...
 function getpono()
	...
	$sql = "select IFNULL(max(ordh_no),0)+1 as po_no from trnirm_order_header where ordh_fincode = '$finid' and ordh_compcode='$compcode'");
    $r = mysqli_query($conn, $sql);
