...
summaryRenderer: function(v, params, data){
    ...
    constructor : function(config){
        ...
        Ext.grid.GroupSummary.superclass.constructor.call(this);
    },
    init : function(grid){
        this.grid = grid;
...
//backwards compat
Ext.grid.GroupSummary = Ext.grid.GroupSummary;
...
Ext.grid.GroupSummary.Calculations = Ext.grid.GroupSummary.Calculations;

/**
 * @class Ext.grid.HybridSummary
 * @extends Ext.grid.GroupSummary
...
//backwards compat
Ext.grid.HybridSummary = Ext.grid.HybridSummary;
