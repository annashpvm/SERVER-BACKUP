...
//echo "<br>"; 
		...
		$ginledcode    = $rec12['acctrail_cust_code'];  
...
//echo "<br>"; 
        $ledcode = 0;
        $ledtype = 'G';
        $ledcode = $pdo->query("select ifnull(max(cust_code),0) as  cust_code  from massal_customer where REPLACE(cust_name, ' ','')  =upper('$colB')")->fetchColumn();
