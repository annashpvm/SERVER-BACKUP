...
if (isset($_POST["Import"])) {
 ...
 $filename=$_FILES["file"]["tmp_name"];
	...
	$cnnt=0;
		...
		$query1 = "select count(*) as nos from tmp_import_cndn_purchase where compcode = $compcode  and fincode = 23 and voutype = 'BANK PAYMENT' and party = '$colC_Actual' and voudate = '$colA' and amount = '$totamt'";
...
//        if  ((trim($colF) == 'Payment'  && trim($colF_Actual) == 'Payment'  ) || (trim($colF) == 'Contra'  && trim($colF_Actual) == 'Contra'  ))
        ...
        if  (trim($colF) == 'Payment'  || trim($colF) == 'Contra')
...
//echo "<br>"; 
	...
	$query123  = "insert into tmp_import_cndn_purchase (compcode, fincode, voutype, vouno, voudate, party, amount) value($compcode,$finid,'BANK PAYMENT','$colG','$colA','$colC_Actual',$totamt)";
