...
//echo $colC;
        ...
        if  ((trim($colE) == 'TN OS GST SALES'  && trim($colE_Actual) == 'TN OS GST SALES')  || (trim($colE) == 'OTHER IGST SALES'  && trim($colE_Actual) == 'OTHER IGST SALES')  || (trim($colE) == 'OS IGST SALES'  && trim($colE_Actual) == 'OS IGST SALES')   ) 
        {
		...
		<div class="row">
			...
			<div class="span6" id="form-login">
				<form class="form-horizontal well"  action="" method="POST" name="upload_excel" enctype="multipart/form-data">
					<fieldset>
						<center><legend> Excel Upload - FOR OTHER SALES </legend></center>
