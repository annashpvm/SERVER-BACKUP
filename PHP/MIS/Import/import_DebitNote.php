 ...
 $filename=$_FILES["file"]["tmp_name"];
	...
	$cnnt=0;
        ...
        while (($packData = fgetcsv($file, 10000, ",")) !== FALSE) {
           ...
           if ($packData[9] != '')      // DEBIT NOTE
            { 
              $colJ = $packData[9];

            if  ($colJ == 'Debit Note(Gst)' || $colJ == 'Debit Note(Gst Sales)' )
                $voutype = "DNG";
            else
                $voutype = "DNN";
           ...
           $colE = 0; 
           if ($packData[4] != '')      //  DEBIT NOTE AMOUNT  
            { 
              $colE = $packData[4];
            }
...
//echo "<br>"; 
        ...
        if ($recfound == 0)     
        { 
        if (($colJ == 'Debit Note'   && trim($colJ_Actual) == 'Debit Note'  ) || ($colJ == 'Debit Note(Gst)'   && trim($colJ_Actual) == 'Debit Note(Gst)'  ) || ($colJ == 'Debit Note(Gst Sales)'   && trim($colJ_Actual) == 'Debit Note(Gst Sales)' ) ) 
        {
                $sno = 0;
...
//for updating  --  tmp_import_cndn_purchase 
        ...
        while (($packData2 = fgetcsv($file2, 10000, ",")) !== FALSE) {
           ...
           if ($packData2[9] != '')      // DEBIT NOTE WORD
            { 
              $colJ = $packData2[9];
           ...
           $colE = 0; 
           if ($packData2[4] != '')      //  DEBIT NOTE AMOUNT  
            { 
              $colE = $packData2[4];
            }
