 ...
 $filename=$_FILES["file"]["tmp_name"];
	...
	$cnnt=0;
        while (($packData = fgetcsv($file, 10000, ",")) !== FALSE) {
         ...
         $insert = $pdo->prepare("insert into maspur_item_header (item_code, item_group_code, item_name, item_usage, item_uom, item_qcchk, item_hsncode, grpname, subgrpname) values ( $reccount,'1',upper(:columnC),'','1','N','1',:columnA,:columnB)");
