...
//            </script>';
         ...
         $insert = $pdo->prepare("insert into maspur_supplier_master (sup_code, sup_led_code, sup_name, sup_refname, sup_addr1, sup_addr2, sup_addr3, sup_city,sup_zip,sup_phone,sup_email, sup_panno, sup_gstin) values ( $reccount,$reccount,UPPER(:columnA), UPPER(:columnA), LEFT(UPPER(:columnB),50),UPPER(:columnC),UPPER(:columnD),UPPER(:columnE),:columnH,:columnI,:columnJ,:columnL,:columnK)");
