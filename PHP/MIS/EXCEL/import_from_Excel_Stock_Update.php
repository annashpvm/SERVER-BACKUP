...
//            $insert = $pdo->prepare("INSERT into masprd_vargrp_color values (:columnA,:columnB,:columnC,:columnD,:columnE)");
         $insert = $pdo->prepare("insert into stock_update (sno, bf, gsm, size, sizetype, rollno, monthr, reelno, weight,shade,customer,stockdate) values (:columnA,:columnB,:columnC,:columnD,:columnE,:columnF,:columnG,:columnH,:columnI,:columnJ,:columnK,:columnL)");
