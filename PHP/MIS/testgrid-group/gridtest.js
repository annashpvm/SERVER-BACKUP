...
//        return v + (record.data.invh_netamt );
//    };
...
var flxSystem = new Ext.grid.EditorGridPanel({
        ...
        columns: [    
            ...
            {header: "invoice no " ,  dataIndex: 'invh_no', sortable:true,width:50,align:'left', menuDisabled: true},
            {header: "invoice date ",  dataIndex: 'invh_date', sortable:true,width:100,align:'left', menuDisabled: true},
            {header: "wt " , dataIndex: 'invh_totwt', sortable:true,width:100,align:'right',summaryType: 'sum',renderer:function (value, record) {return Ext.util.Format.number(value, '0,0.00');}},{header: "Amt " ,  dataIndex: 'invh_netamt',sortable:true,width:100,align:'right',renderer:function (value, record) {return Ext.util.Format.number(value, '0,0.00');            
            },summaryType: 'sum',summaryRenderer:function (value, record){return Ext.util.Format.number(value, '0,0.00');
            }}],
