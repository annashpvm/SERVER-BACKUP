...
labelStyle:{
  ...
  */           
        columns: [    
            {header: "party"       , dataIndex: 'cust_ref', sortable:true,width:250,align:'left', menuDisabled: false,hidden : true},       
            ...
            {header: "wt " , dataIndex: 'invh_totwt', sortable:true,width:100,align:'left', menuDisabled: false ,
        ...
        tbar : [
          {
             ...
             iconCls : 'print',
             handler : function() {
                Ext.GridPriner.print(flxSystem);
             }   
