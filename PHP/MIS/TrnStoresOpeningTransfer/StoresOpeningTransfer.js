		    ...
		    params :
		     {
		       ...
		       finid	    : GinFinid,
		       fromdate	    : Ext.util.Format.date(finstdate,"Y-m-d"),
		       todate	    : Ext.util.Format.date(fineddate,"Y-m-d"),
		       finstartdate : finstdate,
		       RPT	    : "STORELEDGER"
                         ...
                         callback: function(options, success, response)
                              {
                                 ...
                                 if (obj['success']==="true"){
                                    ...
                                    Ext.MessageBox.alert("Stores Year opening Stock Transferred Sucessfully");
                                     ...
                                     Ext.MessageBox.alert("Stores Year opening Stock NOT Transferred.. Pls Check!");                                                  
                                    }
                                }
                           });         
