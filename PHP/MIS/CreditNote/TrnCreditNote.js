...
var cmbQuality = new Ext.form.ComboBox({
    ...
    var txtChangePass = new Ext.form.TextField({
        fieldLabel  : 'Password',
        id          : 'txtChangePass',
        name        : 'txtChangePass',
        inputType: 'password',
	...
	listeners:{
          specialkey:function(f,e){
             if (e.getKey() == e.ENTER)
             {
		    if (txtChangePass.getValue() == "")
		       alert("Enter Password ...");
		    else if (txtChangePass.getValue() != "admin")
               	       alert("Password Error Please check..."); 
                    else
                    {
                        Ext.Msg.show({
                            ...
                            icon: Ext.Msg.QUESTION,
                            buttons: Ext.MessageBox.YESNO,
                            msg: 'Confirm Again Are you sure to Change the  Credit Note No. ...'+cmbCNNo.getRawValue(),
                            fn: function(btn)
                            {
                                if (btn === 'yes')
				{
                                       ...
                                       Ext.Ajax.request({
                                       url: 'FrmTrnCreditNoteNoUpdate.php',
                                       ...
                                       params :
				       {
						...
						RefreshData();
				             ...
				             {
				                Ext.MessageBox.alert("CREDIT NOTE Not Changed . Check " + obj['msg']);                                                  
				              }
				          }
				       });       
		                    }
...
*/
    ...
    var txtNewCNNo = new Ext.form.TextField({
        fieldLabel: 'Credit Note No.',
        id: 'txtNewCNNo',
        width: 120,
        name: 'txtNewCNNo',   
