...
//echo $itemcode;
           ...
           $query2   = mysql_query("select count(*) recfound from masrm_item_trailer where itmt_compcode= 1
and itmt_fincode = $nextfinid  and itmt_hdcode =  $itemcode");
		...
		$result1=mysql_query($query1);       
           ...
           $query2   = mysql_query("select count(*) recfound from masrm_item_trailer where itmt_compcode= 90
and itmt_fincode = $nextfinid  and itmt_hdcode =  $itemcode");
           $findrow  = mysql_fetch_row($query2);
           if ($findrow[0]  == 0)
           {
