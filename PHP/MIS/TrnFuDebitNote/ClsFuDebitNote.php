...
//        $sql = "select * from acc_ledger_master  where led_type = 'G' and  led_code in (1756,1745,1746,2258)";
        ...
        $sql = "select qc_fuel_entryno from trn_qc_fuel_inspection where qc_fuel_compcode = $compcode and qc_fuel_dn_raised ='N' and qc_fuel_supcode = $suppcode and qc_fuel_tot_ded_qty > 0 order by  qc_fuel_entryno desc";
    $r = mysqli_query($conn, $sql);
...
*/
 ...
 function getDebitNoteVoucherListAccounts()
	...
	$finid    = $_POST['fincode'];
        $gsttype =$_POST['gsttype'];
        $sql = "select dbcr_vouno from  tmpacc_dbcrnote_header where dbcr_comp_code = '$compcode' and dbcr_finid ='$finid'  and dbcr_accseqno = 0  order by dbcr_vouno asc ";
...
qc_fuel_debitnote_no = dbcr_vouno and dbcr_comp_code = '$compcode' and dbcr_finid = '$finid' and dbcr_accseqno = 0  order by dbcr_vouno asc";
 ...
 function getDebitNoteUpdateCheck()
	...
	$vouno    = $_POST['vouno'];
        ...
        $sql = "select * from  tmpacc_dbcrnote_header where dbcr_comp_code = '$compcode' and dbcr_finid ='$finid'  and dbcr_vouno = '$vouno'";
