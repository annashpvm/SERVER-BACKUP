<?php
 ...
 function getMonthPODetails()
	...
	$enddate   = $_POST['enddate'];
        ...
        $r=mysql_query(" select ordh_no , ordh_date,cust_ref,itmh_name,ordt_qty,ordt_item_value  from trnrm_order_header a, trnrm_order_trailer b , masrm_item_header c , massal_customer d  where  ordh_sup_code = cust_code and  ordh_compcode = $compcode and ordh_fincode = $finid and ordh_seqno =ordt_hdseqno and  ordt_item_code = itmh_code and ordh_date between '$startdate' and '$enddate' order by ordh_seqno desc");
