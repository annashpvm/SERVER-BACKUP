Ext.onReady(function(){
 ...
 var loadMonthGRNData = new Ext.data.Store({
      ...
      proxy: new Ext.data.HttpProxy({
                url: '/SHVPM/Purchase/RawMaterial/ClsRMRep.php',      // File to connect to
                method: 'POST'
            }),
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },[ 'rech_no' , 'rech_date','cust_ref','itmh_name','rect_grnqty','rect_itemvalue' 
...
var optprinttype = new Ext.form.FieldSet({
 ...
 var cmbReport = new Ext.form.ComboBox({
	...
	emptyText       : '--Select Report Type--',
        mode            : 'local',
        store           : [['1','PURCHASE ORDER'],['2','GRN'],['3','ISSUE SLIP']],
        forceSelection  : true,
        triggerAction   : 'all',
        selectOnFocus   : false, 
        editable        : false,
...
//alert(cmbReport.getValue());
	        ...
	        if (cmbReport.getValue() == "1") {
			    ...
			    loadPOData.load({
				url: '/SHVPM/Purchase/RawMaterial/ClsRMRep.php',
				params: {
			    	task: 'loadMonthPOs',
