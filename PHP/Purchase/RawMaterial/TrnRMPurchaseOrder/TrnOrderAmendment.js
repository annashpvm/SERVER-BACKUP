...
//edit
				...
				var p4 = "&amendno=" + encodeURIComponent(Number(txtAmendNo.getValue()-1));

				var param = (p1+p2+p3+p4) ;     
				if (printtype == "PDF")                       
				window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMPurchaseOrderAmendment.rptdesign&__format=pdf&' + param); 
				else

				window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRMPurchaseOrderAmendment.rptdesign' + param); 
...
//SAVE
            ...
            listeners:{
				...
				amenddate  : Ext.util.Format.date(dtpAmenddate.getValue(),"Y-m-d"),
