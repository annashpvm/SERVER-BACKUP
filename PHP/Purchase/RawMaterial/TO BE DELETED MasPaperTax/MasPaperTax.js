...
var taxseq = 0;
 ...
 var loadtaxlistdatastore = new Ext.data.Store({
      ...
      proxy: new Ext.data.HttpProxy({
                url: 'ClsPaperTax.php',      // File to connect to
                method: 'POST'
            }),
      ...
      reader: new Ext.data.JsonReader({
        ...
        id: 'id'
            ...
            'tax_code', 'tax_name', 'tax_ledcode','txt_purchaseledger', 'tax_cgstper', 'tax_sgstper', 'tax_igstper', 'tax_cgstledcode', 'tax_sgstledcode', 'tax_igstledcode', 'tax_cgstledger', 'tax_sgstledger', 'tax_igstledger', 'tax_gst'
 ...
 var LoadPurchaseLedgerStore = new Ext.data.Store({
      id: 'LoadPurchaseLedgerStore',
      autoLoad:true,
      proxy: new Ext.data.HttpProxy({
                url: 'ClsPaperTax.php',      // File to connect to
                method: 'POST'
            }),
            baseParams:{task:"LoadPurchaseLedger"}, // this parameter asks for listing
      reader: new Ext.data.JsonReader({
                  // we tell the datastore where to get his data from
        root: 'results',
        totalProperty: 'total',
...
var cmbigstledger = new Ext.form.ComboBox({
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
        ...
        columns: [   
            ...
            {header: "Tax Name", dataIndex: 'tax_name',sortable:true,width:180,align:'left'},
            {header: "Purchsae Ledger", dataIndex: 'tax_ledcode',sortable:true,width:60,align:'left'},
            {header: "Purchase Ledger", dataIndex: 'txt_purchaseledger',sortable:true,width:200,align:'left'},
   ...
   var MasPurchaseTaxPanel = new Ext.FormPanel({
                ...
                
         {
				...
				else
				{
					...
					if (btn == 'yes')
						{
						Ext.Ajax.request({
		                            	url: 'FrmMasPaperTaxSave.php',
		                                params:
						{
                                                        saveflag        : AEDFlag,
                                                        taxseq          : taxseq,
							taxname         : txtTaxName.getRawValue(), 
                                                        taxpur_ledcode  : cmbPurchaseledger.getValue(),    
	...
	height      : 600,
        width       : 1000,
        y           : 35,
        title       : 'WASTE PAPER / FUEL GST MASTER',
