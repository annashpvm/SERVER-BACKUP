...
;
 ...
 var loadSupplierListDatastore = new Ext.data.Store({
      ...
      proxy: new Ext.data.HttpProxy({
            ...
            baseParams:{task:"loadGST_DNote_Exemption_List"}, // this parameter asks for listing
	...
	'cust_code', 'cust_name','cust_wp_gst_dnote_yn'
      ]),
    });
...
//            {header: "S.No  ", dataIndex: 'slno',sortable:true,width:30,align:'left'},    
   ...
   function RefreshData(){
	...
	loadSupplierListDatastore.load({
          ...
          params:
       	  {
           task:"loadGST_DNote_Exemption_List"
          }
	});
   };
	        ...
	        if (cnt > 0){
                ...
                {  
                   ...
                   flxDetail.getStore().insert(
                     ...
                     new dgrecord({
                        slno: RowCnt,
                        cust_name  : txtSupplierName.getRawValue(),
                        cust_code  : Suppliercode,
                        cust_wp_gst_dnote_yn : 'Y',
                     })
                    );
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
       ...
       id: 'my-grid',  
    	...
    	style      :"border-radius: 5px;textTransform: uppercase; ",  
        columns: [   
		{header: "Sup Code", dataIndex: 'cust_code',sortable:true,width:90,align:'left', hidden: true},   
		{header: "Sup  Name", dataIndex: 'cust_name',sortable:true,width:500,align:'left'},
		{header: "GST - DNOTE Exemption", dataIndex: 'cust_wp_gst_dnote_yn',sortable:true,width:150,align:'center'},
       ...
       listeners:{
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			{
				if (selected_rows[i].data.cust_wp_gst_dnote_yn == 'N')
                                    flag = 'N';
                                else                                   
                                    flag = 'Y';
                                             
                               	colname = 'cust_wp_gst_dnote_yn';
				if (flag == 'N')
				{
...
//save
	...
	height      : 600,
        width       : 1280,
        y           : 35,
        title       : 'GST DEBIT NOTE EXEMPTION SUPPLIER LIST ',
