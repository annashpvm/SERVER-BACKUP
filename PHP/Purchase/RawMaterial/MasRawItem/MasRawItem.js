...
var cmbItemGroup = new Ext.form.ComboBox({
        ...
        mode            : 'local',
labelStyle : "font-size:14px;font-weight:bold;color:#0080ff",
        store           : [['1','POST-CONSUMER'],['2','PRE-CONSUMER']],
        forceSelection  : true,
        triggerAction   : 'all',
        selectOnFocus   : false,
        editable        : false,
...
//    font-size:18px,
    ...
    [
            ...
            {header: "Group"        , Id: 'itmh_group', sortable:true,width:200,align:'left', menuDisabled: true},  
    ],
	viewConfig: {
    ...
    listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			txtspec.setValue(selrow.get('itmh_specification'));
                        ...
                        cmbItemGroup.setValue(selrow.get('itmh_group'));
