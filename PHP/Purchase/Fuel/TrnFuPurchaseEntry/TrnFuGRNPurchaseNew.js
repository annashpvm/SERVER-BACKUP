...
//Purchase Account - Credit
        ...
        flxAccountsDNOTE.getStore().insert(
	      ...
	      ledname   : cmbPurchaseLedger.getRawValue(),
	      debit     : 0,
              credit    :  Ext.util.Format.number(txtDNValue2.getRawValue() ,'0.00'),
              ledtype   : "G",
              billno    : txtBillno.getRawValue(),
              billdt    : Ext.util.Format.date(dtpBillDate.getValue(),"Y-m-d"),
              }) 
...
function grid_tot_acc(){
       ...
       elrows = flxAccountsDNOTE.getStore().getCount();
...
var flxDetail = new Ext.grid.EditorGridPanel({
	...
	{dataIndex:'dnvalue2', header: "VALUE",width: 60,align: 'center',sortable: true},
...
//FOR DEBIT NOTE ADDITIONS
		                  ...
		                  igstledcode : igstledcode,
                                  qtydiff     : Number(txtBillQty.getValue()) - Number(txtMillQty.getValue()),
