...
$moisARB= (float) $_POST['moisARB'];
$moisADB= (float) $_POST['moisADB'];
$ash    = (float) $_POST['ash'];
$volatile= (float) $_POST['volatile'];
$fixedcarbon=(float) $_POST['fixedcarbon'];
$fines=(float) $_POST['fines'];
$sand=(float) $_POST['sand'];
$iron=(float) $_POST['iron'];
$gcvADB=(float) $_POST['gcvADB'];
$gcvARB=(float) $_POST['gcvARB'];
