...
var lblParty = new Ext.form.Label({
    ...
    id          : 'lblParty',
    width       : 300,
    labelStyle  : "font-size:16px;font-weight:bold;color:#ff4f33",
//    labelStyle : "font-size:12px;font-weight:bold;color:#ff6699",
//    style      : "border-radius:5px;",      
});
	...
	borderStyle: 'solid',
        ...
        listeners: {
            click: function () {
             ...
             if  (Number(txtMonthPurchaseQty.getValue() > 0))
                   {  
 ...
 if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelPartywiseArrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelPartywiseArrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelPartywiseArrivals.rptdesign' + param, '_blank');		
                     }
...
function find_dates(mmon)
{
  ...
  //   lblParty.setText("Detail for");
   //         lblParty.getEl().setStyle('color', 'red');
//            lblParty.getEl().setStyle('font-size', '18px');
//            lblParty.getEl().setStyle('font-weight', 'bold');   
...
var flxParty = new Ext.grid.EditorGridPanel({
    ...
    columns:
    [ 	 	
        {header: "Supplier" , dataIndex: 'sup_code',sortable:false,width:10,align:'left', menuDisabled: true , hidden : true},
        {header: "Supplier" , dataIndex: 'sup_name',sortable:false,width:400,align:'left', menuDisabled: true},
...
//          	find_dates(selrow.get('cust_code'));
            ...
            lblParty.setText("Detail for  : " + selrow.get('sup_name') );
     //       lblParty.getEl().setStyle('color', 'red');
     //       lblParty.getEl().setStyle('font-size', '18px');
    //        lblParty.getEl().setStyle('font-weight', 'bold');   


            repparty = selrow.get('sup_code');
