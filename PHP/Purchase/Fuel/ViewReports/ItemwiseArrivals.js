	...
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    var p1 ="&compcode="+encodeURIComponent(Gincompcode);      
 		    ...
 		    var param = (p1+p2+p3) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelItemwiseArrivals.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelItemwiseArrivals.rptdesign&__format=XLS&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Fuel/repFuelItemwiseArrivals.rptdesign' + param, '_blank');	
                }
            }
