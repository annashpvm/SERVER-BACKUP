...
'phd_podate', 'phd_pono', 'cust_ref', 'item_name', 'uom_short_name', 'pend_qty', 'pend_value', 'rate'
 ...
 var loadSearchItemDatastore = new Ext.data.Store({
      id: 'loadSearchItemDatastore',
//      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: '/SHVPM/Purchase/General/ClsPurRep.php',      // File to connect to
                method: 'POST'
...
function GroupSearch()
{
        ...
        loadSearchItemDatastore.removeAll();
        loadSearchItemDatastore.load({
		url: '/SHVPM/Purchase/General/ClsPurRep.php',
		params:
		{
			task:"loadSearchItemList",
			group : txtItem.getRawValue(),
		},
        });
}
...
//            {header: "S.No  ", dataIndex: 'slno',sortable:true,width:30,align:'left'},    
        ...
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			if ((selrow != null)){
				...
				lblGroup.setText("Detail for   : " + ItemName  );
