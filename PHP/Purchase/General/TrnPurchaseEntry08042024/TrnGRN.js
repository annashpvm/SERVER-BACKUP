...
'minh_gedate', 'minh_lrno', 'minh_lrdate', 'minh_accupd','mint_rebate', 'mint_machine','mint_tcs_per','mint_tcs_amt','mint_accept_qty','mint_otherspm', 'mint_purgroup','led_name','minh_roundneeded','sup_refname','tax_cgstper', 'tax_sgstper', 'tax_igstper', 'tax_cgstledcode', 'tax_sgstledcode', 'tax_igstledcode', 'tax_cgstledger', 'tax_sgstledger', 'tax_igstledger', 'tax_gst','sup_led_code' ,'minh_vou_no'
...
'podate', 'indno', 'indfincode', 'phd_credit_days','phd_tol'
 ...
 var LoadTransClrNodetailDatastore = new Ext.data.Store({
	...
	'sup_refname','t_clr_frt_party','t_clr_lrno','t_clr_lrdt','frt','othexp','ccgstper','csgstper','cigstper'
      ]),
    });
...
//alert(cnt);
		         ...
		         {  
                             ...
                             txtSupplierName.setValue(GRNdetailsLoadDataStore.getAt(0).get('sup_refname'));
