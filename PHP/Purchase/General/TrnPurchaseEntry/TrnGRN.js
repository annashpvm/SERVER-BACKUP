...
'minh_gedate', 'minh_lrno', 'minh_lrdate', 'minh_accupd','mint_rebate', 'mint_machine','mint_tcs_per','mint_tcs_amt','mint_accept_qty','mint_otherspm', 'mint_purgroup','cust_name','minh_roundneeded','cust_ref','tax_cgstper', 'tax_sgstper', 'tax_igstper', 'tax_cgstledcode', 'tax_sgstledcode', 'tax_igstledcode', 'tax_cgstledger', 'tax_sgstledger', 'tax_igstledger', 'tax_gst','sup_led_code' ,'minh_vou_no'
...
//alert(cnt);
		         ...
		         {  
                             ...
                             dtVouDate.setRawValue(Ext.util.Format.date(GRNdetailsLoadDataStore.getAt(0).get('mint_mindate'),"d-m-Y"));
		               ...
		               var mintqcreq1         = GRNdetailsLoadDataStore.getAt(j).get('mint_qc_status');
			             ...
			             totqty:'0',
                 	             itc:'N',
                                     ...
                                     purgrpname        : GRNdetailsLoadDataStore.getAt(j).get('cust_name'),
