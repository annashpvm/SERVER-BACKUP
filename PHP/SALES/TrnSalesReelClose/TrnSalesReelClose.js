...
var LoadordernoItemDetailsDatastore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: 'ClsTrnSalesReelClose.php', // File to connect to
            method: 'POST'
        }),
	...
	tabIndex	: 0,
       ...
       listeners:{
                   	...
                   	callback:function()
			{
                                ...
                                cmbSONo.setValue(LoadReelWeightDatastore.getAt(0).get('stk_sono'));
                                cmbSONo.setRawValue(LoadReelWeightDatastore.getAt(0).get('stk_sono'));
                        }
                 });
    ...
    bodyStyle:{"background-color":"#ebebdf"},  
     listeners:{
               ...
               params:
		{
	           ...
	           if (obj['success']==="true")
	           {                       
                            Ext.MessageBox.alert("Reel Closed -" + obj['msg']);
                            RefreshData();
                    }else
		    {
                           Ext.MessageBox.alert("Reel Not Closed- " + obj['msg']);                                                  
                    }
                }
