...
//	$invtno= $_POST['invhno'];
	...
	$query3= "insert into trnsal_invoice_trailer values('$invhseqno','$invtitem','$invtvar','$invthsncode','$invtwt','$invtnos','$invturate','$invtamt', 
'$invtvalue','$invttaxable','$invtlosspmt','$invtqcdevyn')";
	$result3=mysql_query($query3);          


	$query4= "update trnsal_order_trailer set ordt_des_tag = 'T'  where ordt_sono in (3955) and ordt_fincode = $invhfincode  and ordt_comp_code = $invhcompcode  and ordt_var_code = $invtvar";
	$result4=mysql_query($query4);          
