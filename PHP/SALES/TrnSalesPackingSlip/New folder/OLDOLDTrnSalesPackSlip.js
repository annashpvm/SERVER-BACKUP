					...
					callback:function() 
					{
					 ...
					 cmbSONo.setValue(loadSOnodatastore.getAt(0).get('da_ackno'));
						...
						params: {
						    ...
						    compcode:Gincompcode,
						    dano : loaddanodatastore.getAt(0).get('da_no'),
						    socno : loadSOnodatastore.getAt(0).get('da_ackno')
						},
						callback:function()
						{
...
//    font-size:18px,
	...
	{header: "Units",    dataIndex: 'unittype',sortable:true,width:80,align:'left',hidden:true },
	...
	{header: "UnitCode", dataIndex: 'varunit',sortable:true,width:80,align:'left',hidden:true},
