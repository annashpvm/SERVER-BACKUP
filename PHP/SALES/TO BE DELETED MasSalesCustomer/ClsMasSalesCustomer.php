  ...
  function getsalcustomer()
    {
        ...
        $r=mysql_query("select  a.* , b.cust_ref cust_group , c.usr_name  from massal_customer a,massal_customer b , userMaster c where a.cust_partygroup = b.cust_code and   a.createdby = c.usr_code order by a.cust_ref");
  ...
  function getsalespartygrp()
    {
        ...
        $r=mysql_query("select cust_group , cust_partygroup from (select   b.cust_ref cust_group  , b.cust_partygroup from massal_customer a,massal_customer b where a.cust_partygroup = b.cust_code union all select   cust_ref cust_group  , cust_code cust_partygroup from massal_customer ) a group by cust_group , cust_partygroup order by cust_group");
	$nrow = mysql_num_rows($r);
	while($re = mysql_fetch_array($r))
	{
	$arr[]= $re ;
