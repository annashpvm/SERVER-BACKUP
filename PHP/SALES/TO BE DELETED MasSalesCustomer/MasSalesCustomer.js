...
//save
	            ...
	            listeners:{
                  ...
                  /*  else if (txtsalcustgstno.getRawValue().length != 15)
                    ...
                    else if (cmbCustGroup.getValue()==0 || cmbCustGroup.getRawValue()=="")
                    {
                        Ext.Msg.alert('Sales','Select Customer Group .....');
                        gstSave="false";
                    }
                    ...
                    else if (txtsalcustcreditday.getRawValue()=="")
                    {
...
//SAVE
				...
				custgstin   : txtsalcustgstno.getValue(),
                                ...
                                custgroup   : cmbCustGroup.getValue(), 
