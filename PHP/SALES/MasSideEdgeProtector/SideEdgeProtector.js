...
var UserId   = localStorage.getItem('ginuserid');
 ...
 var loadSideEdgeCustomerListDatastore = new Ext.data.Store({
      id: 'loadSideEdgeCustomerListDatastore',
      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: 'clsSideEdgeProtector.php',      // File to connect to
                method: 'POST'
            }),
            baseParams:{task:"loadSideEdgeList"}, // this parameter asks for listing
	...
	'cust_code','cust_ref','cust_addnlwt'
...
var cmbCustomer = new Ext.form.ComboBox({
   ...
   function RefreshData(){
        ...
        loadSideEdgeCustomerListDatastore.removeAll();
	loadSideEdgeCustomerListDatastore.load({
          url:'clsSideEdgeProtector.php',
          params:
       	  {
           task:"loadSideEdgeList"
          }
	});
   };
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
       ...
       id: 'my-grid',  
		...
		{header: "ADDNL WT ", dataIndex: 'cust_addnlwt',sortable:true,width:100,align:'left'},

        ],
       store:loadSideEdgeCustomerListDatastore,
       ...
       listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			{
				if (selected_rows[i].data.cust_addnlwt == 'N')
                                    flag = 'N';
                                else                                   
                                    flag = 'Y';
                                             
                               	colname = 'cust_addnlwt';
				if (flag == 'N')
				{
   ...
   var MasSideEdgerpanel = new Ext.FormPanel({
...
*/
					...
					if (btn == 'yes')
                                            	...
                                            	if (obj['success'] === "true") 
						{
						    ...
						    MasSideEdgerpanel.getForm().reset();
							RefreshData();
...
//				}
                ...
                },'-',
                {
                    ...
                    handler: function(){	
                            MasSideEdgeCustomerWindow.hide();
                        }
                }]
        },
        items: [
    ...
    var MasSideEdgeCustomerWindow = new Ext.Window({
	height      : 600,
        width       : 1280,
        y           : 35,
        title       : 'SIDE EDGE PROTECTOR CUSTOMER LIST',
        items       : MasSideEdgerpanel,
        layout      : 'fit',
    ...
    MasSideEdgeCustomerWindow.show();  
});
