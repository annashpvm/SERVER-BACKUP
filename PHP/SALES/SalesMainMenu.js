...
var map = new Ext.KeyMap(document, [
...

    {
        ...
        fn: function() {
             window.location.href=('http://10.0.0.251/SHVPM/SALES/MasSalesRate/FrmMasCustomerPrice.php');
        }
    },
...

    {
        ...
        fn: function() {
             window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesPackingSlip/TrnSalesPackSlipNew.php');
        }
    },
...
*/
    		...
    		{
                    text: '<b>SALES ORDER - DESTINATION ENABLE CUSTOMER LIST</b>',
                    group: 'theme',
                    handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/MasSODestinationEnable/frmDestinationEnable.php');
...
*/
               	{
                    text: '<b>SIZE MASTER - NEW </b>',
                    group: 'theme',
                     handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/MasSize/FrmMasSizeNew.php');
                    }
                },
               	...
               	{
                    text: '<b>AREA - RATE  MASTER </b>',
                    group: 'theme',
                     handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/MasAreaGroup/FrmMasAreaRateGroup.php');
                    }
                },
...
*/
            	{
                    text: '<b>AREAWISE PRICE MASTER </b>',
                    group: 'theme',
                    id : 'areaprice',   
                    handler: function(){
...
/*
            	{
                    text: '<b>CUSTOMERWISE PRICE MASTER - NEW </b>',
                    group: 'theme',
                    handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/MasSalesRate/FrmMasCustomerPriceNew.php');
                    }
                },
...
/*
               	{
                    text: '<b>SALES ORDER ENTRY - NEW </b>',
                    group: 'theme',
                    handler: function(){
                         localStorage.setItem("SOTYPE",'F');  
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesOrder/TrnSalesOrderNew.php');
                    }
                },
            	...
            	{
                    text: '<b>old SALES ORDER ENTRY </b>',
                    group: 'theme',
                    handler: function(){
                         localStorage.setItem("SOTYPE",'F');  
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesOrder/TrnSalesOrder.php');
...
*/
            	{
                    text: '<b>SALES ORDER ENTRY - OLD </b>',
                    group: 'theme',
                    id   : 'so2',
                    handler: function(){
                         localStorage.setItem("SOTYPE",'S');  
//                        window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesOrder/TrnSalesOrder.php');
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesOrder/TrnSalesOrder.php');
            	...
            	{
                    text: '<b>SO RATE - REVISION  </b>',
                    group: 'theme',
                    handler: function(){
                            window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesOrder/TrnSORateChange.php');
...
*/
        	...
        	{
                    text: '<b>DELIVERY NOTE</b>',
                    group: 'theme',
                    id   : 'dc',
                    handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/TrnSalesDeliveryNote/TrnSalesDeliveryNote.php');
	                    }
                },
...
*/
   ...
   new Ext.Toolbar.SplitButton({
        ...
        menu:{
            ...
            items:[
           	...
           	{
                    text: '<b> SALES ORDER AND DESPATCH DETAILS </b>',
                    group: 'theme',
                    handler: function(){
                        window.location.href=('http://10.0.0.251/SHVPM/SALES/ViewSales/RepViewSONOHistory.php');
                    }
                },
                ...
                },
 {
		        ...
		        text: '<b>AVERAGE COST REPORTS</b>',
		        group: 'theme',
		        handler: function(){
			    
		            window.location.href=('http://10.0.0.251/SHVPM/SALES/RepSALReports/SALAveragecostReports/RepAveragecost.php'); 
		        }
