...
var optRepOpt = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optRepopt',
        items: [
		{boxLabel: 'Date wise', name: 'optRepopt', id:'optdate', inputValue: 1,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
					    repopt = 'Datewise';
		...
		{boxLabel: 'Rep Wise', name: 'optRepopt', id:'optrep', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						repopt = 'Repwise';
...
//alert(repopt);
                	    	...
                	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Sales/RepPartywiseOrderStatus.rptdesign' + param, '_blank');
                                ...
                                {
               	                if (printtype == "PDF") 
                	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Sales/RepDatewiseOrderReceived.rptdesign&__format=pdf&' + param, '_blank');
                                else if (printtype == "XLS") 
                	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Sales/RepDatewiseOrderReceived.rptdesign&__format=XLS&' + param, '_blank');
                                else
                	    	window.open('http://10.0.0.251:8080/birt/frameset?__report=Sales/RepDatewiseOrderReceived.rptdesign' + param, '_blank');
                                }             
