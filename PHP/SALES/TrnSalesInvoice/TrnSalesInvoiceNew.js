...
//    	style      :"border-radius: 5px;  textTransform: uppercase ", 
   ...
   var txtUnloadingPerMT = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtUnloadingPerMT',
        name        : 'txtUnloadingPerMT',
        width       :  60,
    	labelStyle	: "font-size:12px;font-weight:bold;",
    	style      :"border-radius: 5px;  textTransform: uppercase ", 
    	enableKeyEvents: true,
   ...
   var txtUnloadingAmount= new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtUnloadingAmount',
        name        : 'txtUnloadingAmount',
        width       :  60,
    	labelStyle	: "font-size:12px;font-weight:bold;",
    	style      :"border-radius: 5px;  textTransform: uppercase ", 
    	enableKeyEvents: true,
