...
//      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: 'ClsTrnSalesInvoiceDelete.php',      // File to connect to
                method: 'POST'
            }),
...
/*
   ...
   {
      if (txtPassword.getRawValue() == "DELETE1234")
      {
        Ext.getCmp('save').setDisabled(false);
      }
      else
...
/*
			...
			PackslipdetailDataStore.load({
                        ...
                        url: 'ClsTrnSalesInvoiceDelete.php',
                        params:
                            {
                                task:"loadslipdet",
...
//save
                    ...
                    if (txtInvNo.getRawValue()==0 || txtInvNo.getRawValue()=="")
                    {
                        ...
                        Ext.Msg.show({
                            ...
                            icon: Ext.Msg.QUESTION,
                            buttons: Ext.MessageBox.YESNO,
                            msg: 'Do You Want To Delete the Invoice ...'+cmbInvNo.getRawValue(),
                            fn: function(btn)
                            {
                                if (btn === 'yes')
				{
                        ...
                        Ext.Msg.show({
                            ...
                            icon: Ext.Msg.QUESTION,
                            buttons: Ext.MessageBox.YESNO,
                            msg: 'Confirm Again Are you sure to Delete the Invoice ...'+cmbInvNo.getRawValue(),
                            fn: function(btn)
                            {
                                if (btn === 'yes')
				{
                                   ...
                                   {  
                                      ...
                                      Ext.each(invData, function (record) {
                                       ...
                                       Ext.Ajax.request({
                                       url: 'TrnSalesInvoiceDeleteSave.php',
                                       ...
                                       params :
				       {
				        ...
				        callback: function(options, success, response)
				        {
                  			    ...
                  			    if (obj['success']==="true")
				            {                                
				                Ext.MessageBox.alert("Invoice Delete -" + obj['msg']);
				                TrnSalesInvoicePanel.getForm().reset();
				                RefreshData();
				             }else
				             {
				                Ext.MessageBox.alert("Invoice Not Deleted . Check " + obj['msg']);                                                  
				              }
				          }
				       });       
		                    }
