<?php
 ...
 function getInvoiceNo()
	...
	$compcode = $_POST['compcode'];
        $sql = "select ifnull(max(invh_no),0)+1 as invno from trnsal_proforma_invoice where invh_fincode= $finid  and invh_comp_code= $compcode";
 ...
 function getInvoiceNoList()
	...
	$compcode = $_POST['compcode'];
        ...
        $sql = "select invh_no  from trnsal_proforma_invoice where invh_fincode= '$finid'  and invh_comp_code= '$compcode'  group by invh_no  order by invh_no desc";
    $r = mysqli_query($conn, $sql);
 ...
 function getInvoiceNoDetails()
	...
	$compcode = $_POST['compcode'];
	$invno    = $_POST['invno'];
        $sql = "select * from trnsal_proforma_invoice  , massal_customer , masprd_variety where  var_groupcode = invh_variety and invh_party = cust_code and  invh_fincode= $finid  and invh_comp_code= $compcode and invh_no = $invno ";
 ...
 function getcustomer()
    {
        ...
        $sql = "select cust_code,cust_ref from  massal_customer group by cust_code,cust_ref order by cust_code,cust_ref";
    $r = mysqli_query($conn, $sql);
...
//and ordh_ackdate = '$orddate' and ordh_fincode = $fincode and ordh_comp_code = $compcode and ordh_tax = tax_code ";
        ...
        $sql = "select cust_ref as agentname,ordh_agent as agentcode,ordh_tax as taxcode, tax_name,ordh_sgst,ordh_cgst,ordh_igst,ordh_ins_yn ,ordh_insper,
 ...
 function gethsnlist()
    {
        ...
        $sql = "select vargrp_type_hsncode hsncode from masprd_type group by vargrp_type_hsncode";
    $r = mysqli_query($conn, $sql);
 ...
 function getcustomer_GST()
    {
 	...
 	$custcode = $_POST['custcode'];
        $sql = "select cust_taxtag from  massal_customer where cust_code = $custcode";
    $r = mysqli_query($conn, $sql);
 ...
 function getHSNcode()
    {
 	...
 	$varcode = $_POST['varcode'];
        $sql = "select * from masprd_variety , masprd_type where var_typecode = vargrp_type_code and var_groupcode = $varcode";
    $r = mysqli_query($conn, $sql);
