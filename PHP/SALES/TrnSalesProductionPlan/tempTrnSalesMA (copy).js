Ext.onReady(function(){
   ...
   var txtPriority = new Ext.form.NumberField({
    ...
    var dptAdvNo= new Ext.form.DateField({
        fieldLabel: 'Date',
        id: 'dptAdvNo',
        name: 'Date',
        format: 'd-m-Y',
...
var tabSalesInvoice = new Ext.TabPanel({
...
var TrnSalesInvoiceWindow = new Ext.FormPanel({
...
Ext.MessageBox.alert("Purchase Order Not Completed! Pls Check!- " + obj['pono']);                                                  
 ...
 var TrnSalesInvoiceWindow = new Ext.Window({
	height      : 600,
        width       : 1100,
        y           : 30,
        title       : 'SALES - ORDER ACCEPTANCE ENTRY',
