...
//	readOnly : true,   
 ...
 var findProdType = new Ext.data.Store({
  ...
  var loadeditApprovalNo = new Ext.data.Store({
    ...
    'arearate_comp_code','arearate_fincode','arearate_sno','arearate_appr_date','arearate_wef','arearate_area', 'arearate_vartype','arearate_gst_per','arearate_gsmfrom','arearate_gsmto','arearate_grm_fr_rate','arearate_gsm_br_rate',
...
'arearate_extraamt3','arearate_gsmfrom4','arearate_gsmto4','arearate_extraamt4','arearate_othershades','area_bf18gsm120',
			...
			params: {
                       	...
                       	callback:function()
				{
 				  ...
 				  flxRateDetail.getStore().removeAll();
					   ...
					   gsmfrrate : Number(loadeditApprovalNo.getAt(j).get('arearate_grm_fr_rate')), 
            ...
            select: function () 
                {
                        ...
                        {
                           Ext.getCmp('pb').show();  
                           Ext.getCmp('kraft').hide();  
                        }
                        else
                        {
                           Ext.getCmp('pb').hide();  
                           Ext.getCmp('kraft').show();  
                        }
...
function add_btn_click()
{
	...
	sel[idx].set('ar3gsmfrom' , Number(txtIncRate2.getValue()));
	sel[idx].set('ar3gsmto' , Number(txtGSMFrom4.getValue()));
