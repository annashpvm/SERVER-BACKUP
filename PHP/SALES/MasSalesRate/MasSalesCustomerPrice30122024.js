...
'rate_bf12','rate_bf12_bit','rate_grace_days'
...
//                        FlxReel.getStore().removeAll();
   ...
   /*
                                  txtGSMFrom2.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmfrom2'));     
                                  txtGSMTo2.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmto2'));     
                                  txtGSMFrom3.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmfrom3'));     
                                  txtGSMTo3.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmto3'));     
                                  txtGSMFrom4.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmfrom4'));     
                                  txtGSMTo4.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_gsmto4'));     
                                  txtIncRate1.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_extraamt2'));
                                  txtIncRate2.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_extraamt3'));

                                  txtIncRate3.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_extraamt4'));
                                  txtothershades.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_othershades'));
                                  txtSheetRate.setValue(loadAreaApprovalDetail.getAt(0).get('arearate_sheet_extraamt'));
...
var lblrate = new Ext.form.Label({
   ...
   function getOldEntryNo()
   {
	  ...
	  flxRateDetail.getStore().removeAll();
                                  ...
                                  txtPriceTerms.setValue(loadeditApprovalNo.getAt(0).get('rate_price_terms'));
...
*/
        ...
        {  
           if (sel[0].data.bf14.toString().length > 0 )
        ...
        {  
           if (sel[0].data.bf16.toString().length > 0 )
        ...
        {  
           if (sel[0].data.bf18.toString().length > 0 )
        ...
        {  
           //if (sel[0].data.bf20.toString().length > 0 )
//            alert("Error in Rate for BF20...");
        ...
        {  
           if (sel[0].data.bf22.toString().length > 0 )
        ...
        {  
           if (sel[0].data.bf24.toString().length > 0 )
        ...
        {  
           if (sel[0].data.bf26.toString().length > 0 )
        ...
        {  
           if (sel[0].data.bf28.toString().length > 0 )
        ...
        if (sel[0].data.bf30.toString().length == 5)
          ...
          {  
           if (sel[0].data.bf30.toString().length > 0 )
...
//save
            ...
            Ext.each(rateData, function (record) {
	         ...
	         //-- loop y Start     
							Ext.Ajax.request({
				                    	url: 'FrmMasSalesCustomerRateSave.php',
				                        params:
							{
                                                        savetype:gstFlag,
