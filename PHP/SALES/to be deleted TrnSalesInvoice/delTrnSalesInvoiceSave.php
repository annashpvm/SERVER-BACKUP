...
$ginaccrefseq = $rec1['con_value'];
 ...
 $query1 = "select  count(*) as nos from trnsal_invoice_header where invh_fincode = $invhfincode and invh_comp_code= $invhcompcode and invh_invrefno = 'invhrefno'";
    $result1= mysql_query($query1);
...
if ($invhroff > 0)
{
    $querya10  = "call acc_sp_trn_insacc_tran('$ginaccrefseq',$seqno,'1',0,'$invhroff','$invhroff',1,0,0,'','$voutype');";
    $resulta10 = mysql_query($querya10);
    $seqno    = $seqno + 1;	
...
{
    $invhroff = $invhroff * -1;
    $querya10  = "call acc_sp_trn_insacc_tran('$ginaccrefseq',$seqno,'1','$invhroff','0','$invhroff',1,0,0,'','$voutype');";
    $resulta10 = mysql_query($querya10);
    $seqno    = $seqno + 1;	
