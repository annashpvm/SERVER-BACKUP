...
'invh_vouno','invh_acc_refno','invh_seqno','invh_ewaybillno','U_TCSStatus','invh_tcs_per', 'invh_tcs_amt'
...
//alert(loadAllCustomerStore.getAt(0).get('cust_email'));

                           if (loadAllCustomerStore.getAt(0).get('cust_phone') == '' ||  loadAllCustomerStore.getAt(0).get('cust_email') == '')
                           { 
                       	         Ext.getCmp('btnEInvoice').hide();
                                 alert("Customer Phone /  Email id is empty.. Please check and continue");
                           }
