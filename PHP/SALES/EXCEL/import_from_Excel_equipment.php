 ...
 $filename=$_FILES["file"]["tmp_name"];
	...
	$cnnt=0;
        while (($packData = fgetcsv($file, 10000, ",")) !== FALSE) {
         ...
         $insert = $pdo->prepare("insert into mas_equipment (equip_code,equip_name,equip_section, equip_machine, equip_cogen, section) values ( $reccount,:columnB,'0','Y','Y',:columnA)");
