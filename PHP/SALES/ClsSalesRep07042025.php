  ...
  from  (
   ...
   select stk_var_code as var_code,  0 as stk_qty, 
     ...
     case when var_unit = 1 then count(*) else 0  end as reel_nos, 0 as salvage_recpt_qty,0 as salvage_recpt_nos,
      0 as conv_qty,0 as conv_nos , 0 as op_nos,0 as op_qty from trnsal_finish_stock, massal_variety where  stk_var_code = var_code and  stk_ent_date >= '$startdate'  and stk_ent_date <= '$enddate' and stk_comp_code = '$compcode' and stk_source = 'C'  group by stk_var_code 
   ...
   select stk_var_code as var_code,  0 as stk_qty, 
     ...
     0 as conv_qty,0 as conv_nos , 0 as op_nos,0 as op_qty from trnsal_finish_stock, massal_variety where  stk_var_code = var_code and  stk_ent_date >= '$startdate'  and stk_ent_date <= '$enddate' and stk_comp_code = '$compcode' and stk_source = 'S'  group by stk_var_code 
...
select oldsize as var_code ,0 as stk_qty,0 as prod_qty ,0 as sal_qty  , 0 as salr_qty,0 as wt_change,0 as stk_nos,0 as sal_val,0 as cgst,0 as sgst,0 as igst,  0 as prod_nos,0 as sal_nos,0 as salret_nos,0 as wtchg_nos,0 as pulp_nos, 0 as pulp_stk,sum(oldweight)/1000  as salvage_stk,count(*)  as salvage_nos , 0 as bund_qty,0 as bund_nos,  0 as reel_qty, 0  as reel_nos , 0 as salvage_recpt_qty,0 as salvage_recpt_nos ,0 as conv_qty,0 as conv_nos , 0 as op_nos,0 as op_qty from  (select oldreelno,oldsize,oldweight from trnsal_salvage , trnsal_finish_stock    where   stk_comp_code = comp_code and  fin_code >= stk_finyear  and oldreelno = stk_sr_no  and ent_date >= '$startdate' and ent_date <= '$enddate' and  comp_code = $compcode and  fin_code = $finid   group by oldreelno,oldsize,oldweight) a1 group by oldsize
