...
for($i=0;$i<$rowcnt;$i++)
{
	...
	$query2= "insert into trn_delivery_note values ('$compcode','$finid','$dnno','$dndate','$party','$truck','$soentno','$soentdate','$itemcode','$startno','$weight','$fincode','$rate','$freight','$vehicle','$tax','$ordno','$orddate')";
