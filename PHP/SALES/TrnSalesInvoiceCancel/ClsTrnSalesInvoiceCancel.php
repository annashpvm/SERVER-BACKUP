<?php
 ...
 function getInvoiceNoList()
	...
	$invhdate = $_POST['invhdate'];
        ...
        $r=mysql_query("select *   from trnsal_invoice_header where invh_fincode=  $fincode  and invh_comp_code= $compcode and invh_date = '$invhdate'  and invh_seqno in (select  max(invh_seqno) from trnsal_invoice_header where invh_fincode=  $fincode and invh_comp_code= $compcode and invh_date = '$invhdate' and E_inv_confirm = 'Y' )");

//        $r=mysql_query("select * from trnsal_invoice_header where invh_fincode=  $fincode  and invh_comp_code= $compcode and invh_date = '$invhdate'");

        $r=mysql_query("select *   from trnsal_invoice_header where invh_fincode=  $fincode  and invh_comp_code= $compcode and invh_date = '$invhdate' and E_inv_confirm = 'Y'  order by invh_seqno desc");
