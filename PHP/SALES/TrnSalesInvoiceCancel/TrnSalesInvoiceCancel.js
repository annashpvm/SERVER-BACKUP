...
//      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: 'ClsTrnSalesInvoiceCancel.php',      // File to connect to
                method: 'POST'
            }),
...
'invh_vouno','invh_acc_refno','invh_seqno','invh_ewaybillno','invh_tcs_per','invh_tcs_amt'
    ...
    bodyStyle:{"background-color":"#ebebdf"},  
     listeners:{
         click: function(){              
                   ...
                   Ext.Ajax.request({
	                url: 'TrnSalesInvoieEditSave.php',
	                params: {
	      
				invhfincode:GinFinid,
				invhcompcode:Gincompcode,
                        	invhno:cmbInvNo.getValue(),
...
function datecheck()
  {
        ...
        if (diffdays >1)
        {     
             alert("You are Not Allowed to Cacnel the invoice in the date of " +  Ext.util.Format.date(dt_invoice,"d-m-Y"));
        ...
        if (diffdays == 0 || diffdays == 1)  
        {
     			...
     			url: 'ClsTrnSalesInvoiceCancel.php',
			params: {
...
/*
   ...
   {
      if (txtPassword.getRawValue() == "CLOSE1234")
      {
...
//save
                    ...
                    if (txtInvNo.getRawValue()==0 || txtInvNo.getRawValue()=="")
                    {
                        ...
                        Ext.Msg.show({
                            ...
                            icon: Ext.Msg.QUESTION,
                            buttons: Ext.MessageBox.YESNO,
                            msg: 'Do You Want To Cancel the Invoice ...'+cmbInvNo.getRawValue(),
                            fn: function(btn)
                            {
                                if (btn === 'yes')
				{
                        ...
                        Ext.Msg.show({
                            ...
                            icon: Ext.Msg.QUESTION,
                            buttons: Ext.MessageBox.YESNO,
                            msg: 'Confirm Again Are you sure to Cancel the Invoice ...'+cmbInvNo.getRawValue(),
                            fn: function(btn)
                            {
                                if (btn === 'yes')
				{
                                   ...
                                   {  
                                      ...
                                      Ext.each(invData, function (record) {
                                       ...
                                       Ext.Ajax.request({
                                       url: 'TrnSalesInvoiceCancelSave.php',
                                       ...
                                       params :
				       {
				        ...
				        callback: function(options, success, response)
				        {
                  			    ...
                  			    if (obj['success']==="true")
				            {                                
				                Ext.MessageBox.alert("Invoice Cancelled -" + obj['msg']);
				                TrnSalesInvoicePanel.getForm().reset();
				                RefreshData();
				             }else
				             {
				                Ext.MessageBox.alert("Invoice Not Cancelled . Check " + obj['msg']);                                                  
				              }
				          }
				       });       
		                    }
