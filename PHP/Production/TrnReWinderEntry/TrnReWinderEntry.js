...
var txtEditSet = new Ext.form.NumberField({
        fieldLabel  : 'Set',
        id          : 'txtEditSet',
        name        : 'txtEditSet',
        width       : 50,
...
var txtEditWinderDeckle = new Ext.form.NumberField({
        fieldLabel  : 'W.Deck',
        id          : 'txtEditWinderDeckle',
        name        : 'txtEditWinderDeckle',
        width       : 50,
        enableKeyEvents: true,
    	labelStyle : "font-:10px;font-weight:bold;",
    	style      : "border-radius:5px;",     	
...
var btnmodify = new Ext.Button({
   ...
   listeners:{
	   ...
	   var gstadd="true";
			...
			sel[idx].set('set'     , txtEditSet.getRawValue());
			sel[idx].set('deckle'  , txtEditWinderDeckle.getValue());
		     ...
		     if (btn === 'yes')
				...
				editrow = selrow;
					...
					cmbWinderNo.setValue(selrow.get('windno'));
		    			...
		    			txtEditSet.setRawValue(selrow.get('set'));
					txtEditSet.setValue(selrow.get('set'))

					txtEditWinderDeckle.setValue(selrow.get('deckle'));
