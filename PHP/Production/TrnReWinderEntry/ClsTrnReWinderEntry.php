<?php
 ...
 function getRWEntryNoDetail()
	...
	$entryno  = $_POST['entryno'];
        ...
        $sql = "select  * from trn_dayprod_rewinder a , masprd_variety b , mas_supervisor c  where r_w_date = '$rdate' and  r_fincode = '$finid'  and  r_compcode = '$compcode' and r_entryno =  $entryno and r_varietycode = var_groupcode and spvr_code = r_operator");
