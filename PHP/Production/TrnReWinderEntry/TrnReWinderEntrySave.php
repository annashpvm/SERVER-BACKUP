...
//	$custcode  = $griddet[$i]['custcode'];
	...
	if ($qlycode >0)
	{
           if ($process == 'N')
           { 
           	$query1   = "insert into  trn_dayprod_rewinder values ('$rcompcode','$rfincode','$proddate','$seqno','$rwdate','$rentryno','$rshift',
	'$roperator','$rollno','$qlycode','$mcshift','$rrollwt','$windno','$set','$deckle','$size','$joints','$dia','0','0','0','$reelno',
