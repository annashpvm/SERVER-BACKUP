...
DROP TABLE IF EXISTS `emp_complaint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `emp_complaint` (
  `r_date` datetime NOT NULL,
  `r_no` int DEFAULT NULL,
  `emp_name` varchar(30) DEFAULT NULL,
  `emp_dept` varchar(30) DEFAULT NULL,
  `emp_sub` varchar(100) DEFAULT NULL,
  `emp_body` varchar(500) DEFAULT NULL,
...
LOCK TABLES `emp_complaint` WRITE;
/*!40000 ALTER TABLE `emp_complaint` DISABLE KEYS */;
/*!40000 ALTER TABLE `emp_complaint` ENABLE KEYS */;
UNLOCK TABLES;
