...
CREATE TABLE `company_master` (
  ...
  `comp_upw` varchar(8) NOT NULL,
  `comp_hpw` varchar(8) NOT NULL,
...
INSERT INTO `company_master` VALUES (1,'PAPER  M/C 1','dpm','dpmho',0.00000),(2,'PAPER M/C 3','dpm3','slpbho',0.00000),(3,'VIJAYALAKSHMI PAPER MILLS','vjpm','vjpmho',0.00000),(4,'PAPER M/C 2','dpm2','dpm2ho',0.00000);
...
-- Dump completed on 2022-05-16  9:31:44
