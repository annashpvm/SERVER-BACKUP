...
var flxstktransdetails = new Ext.grid.EditorGridPanel({
        ...
        columns: [   
            ...
            {header: "Reel No", dataIndex: 'reel_no',sortable:true,width:80,align:'left'},
            ...
            {header: "FROM", dataIndex: 'from',sortable:true,width:100,align:'left'},            
            {header: "VARIETY", dataIndex: 'varty',sortable:true,width:100,align:'left'},
            {header: "BRI", dataIndex: 'bri',sortable:true,width:120,align:'left'},
            {header: "Location", dataIndex: 'location',sortable:true,width:50,align:'left'},
            {header: "Refno", dataIndex: 'ref_no',sortable:true,width:120,align:'left'},                                                
        ],
store:[''], //loadsalledgerlistdatastore,
   });

var txtreels = new Ext.form.NumberField({
        fieldLabel  : 'Reels',
        id          : 'txtreels',
        name        : 'txtreels',
        width       : 90,
...
var flxsizedetails = new Ext.grid.EditorGridPanel({
        ...
        columns: [   
            ...
            {header: "Godown Name", dataIndex: 'godown_name',sortable:true,width:120,align:'left'},   
            {header: "Godown Code", dataIndex: 'godown_code',sortable:true,width:90,align:'left'},
           ],
store:[''], //loadsalledgerlistdatastore,
   });
   
var TrnWarehouseStkTransferReelFormPanel = new Ext.form.FormPanel({
        renderTo    : Ext.getBody(),
        xtype       : 'form',
        title       : 'WARE HOUSE STOCK TRANSFER - REEL',
        width       : 630,
        height      : 460,
	...
	labelStyle : "font-size:12px;font-weight:bold;",
   	style      : "border-radius:5px;", 	
        frame       : false,
        id          : 'TrnWarehouseStkTransferReelFormPanel',
        method      : 'post',
        layout      : 'absolute',
            ...
            items: [
		    {
                ...
                },'-',
               {
                ...
                },'-',
                {
                    ...
                    listeners:{
                        click: function () {
                            TrnWarehouseStkTransferReelWindow.RefreshData();
                        }
                    }
                },'-',
                {
                    ...
                    listeners:{
                        click: function(){
                            TrnWarehouseStkTransferReelWindow.hide();
                        }
                    }
                }
                ]
     ...
     var TrnWarehouseStkTransferReelWindow = new Ext.Window({
        height      : 550,
        width       : 780,
        y           : 40,
        layout      : 'fit',
        items       : TrnWarehouseStkTransferReelFormPanel,
        closable    : true,
        minimizable : true,
        maximizable : true,
        resizable   : false,
	...
	bodyStyle:{"background-color":"#E9EEDD"},
       ...
       TrnWarehouseStkTransferReelWindow.show();
});
