<?php
 ...
 function getloadprodvargrp()
	...
	$r=mysql_query("select mis_batchvariety from trn_mis_mc_dailyprodn a , mas_mis_variety_batch_group b where t_compcode in (1,2,3,4) and t_fincode = '$finid'  and t_date = '$tdate' and mis_batchcode = t_dip_batch group by mis_batchvariety");
 ...
 function getloaddownvargrp()
	...
	$r=mysql_query("select * from mas_mis_downtime  order by mis_downtimename");
