...
var fm = Ext.form;
   ...
   var flxdeptdetail = new Ext.grid.EditorGridPanel({
       ...
       // style:"font-size:60px;padding:10px 0px 0 15px",
        ...
        columns: [    
            {header: "Dept code", Id: 'department_code', sortable:true,width:100,align:'left', menuDisabled: true,hidden : true},
...
store:loaddepartmentdatastore ,
    listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			txtdepartmentname.setValue(selrow.get('department_name'));
	...
	store       : loaddepartmentdatastore,
    	...
    	listeners : {
            keyup: function () {
                    ...
                    flxdeptdetail.getStore().filter('department_name', txtdepartmentname.getValue());  
            }
        }
