...
var GinUserName = localStorage.getItem('ginusername');
...
var newcode = 0;
    ...
    var chkAddrChange = new Ext.form.Checkbox({
		...
		txtOldName.setRawValue(txtcrrefname.getRawValue());
...
var btnSupplierMove = new Ext.Button({
    id      : 'btnSupplierMove',
    style   : 'text-align:center;',
    text    : " Move To Debtors",
    tooltip : 'Debtors Move',
    width   :  50,
    ...
    listeners:{
       click: function(){
             ...
             else
             {
		      ...
		      {
		         Ext.MessageBox.alert("Supplier Moved to Debtor Master "); 
...
function LedgerSearch()
{
		...
		params:
		{
			...
			ledger : txtcrrefname.getRawValue(),
...
*/
             ...
             flxCreditorDetail.getSelectionModel().selectRow(0)
             flxCreditorDetail.focus;
             flxCreditorDetail.getView().focusRow(0);
             }
             if (e.getKey() == e.UP)
             {
	    ...
	    keyup: function () {
                ...
                if  (newcode == 0)
                {
                flxCreditorDetail.getEl().setStyle('z-index','10000');
                flxCreditorDetail.show();
                loadcrdrlistdatastore.removeAll();
                  if (txtcrrefname.getRawValue() != '' )
                     LedgerSearch();
                }  
            }
...
var txtOldName = new Ext.form.TextField({
	fieldLabel  : 'OLD NAME',
	id          : 'txtOldName',
	name        : 'txtOldName',
	width       :  300,
...
//SAVE           
		{
	            ...
	            listeners:{
                    ...
                    else if (cmbGSTtype.getRawValue()=="")
                    {
                        Ext.Msg.alert('Creditor','Select GST Type....');
                        gstSave="false";
                    }
