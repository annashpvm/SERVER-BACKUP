...
var optRpttype = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optRpttype',
        items: [
		{boxLabel: 'Daily Outward', name: 'optRpttype', id:'optDS', inputValue: 1,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						Rpttype="Daily Outward";
...
var tabsalstmt = new Ext.TabPanel({
	...
	{
            xtype: 'panel',
            title: 'Outward Reports',bodyStyle:{"background-color":"#ebebdf"},
            layout: 'absolute',
            items: [optRpttype
		]
	},
...
var RepOutwardPannel = new Ext.FormPanel({
	...
	reader: new Ext.data.JsonReader({
        ...
        tbar: { 
			...
			{
			    if (Rpttype == "Daily Outward") {				
			    	window.open('http://10.0.0.251:8080/birt/frameset?__report=inwardoutward/rpt_outward_datewise.rptdesign' + param, '_blank'); 
...
RepOutwardWindow.hide();
    ...
    var RepOutwardWindow = new Ext.Window({
	height      : 550,
        width       : 750,
	x	    : 200,
        y           : 35,
        title       : 'Outward Reports',
        items       : RepOutwardPannel,
        layout      : 'fit',
