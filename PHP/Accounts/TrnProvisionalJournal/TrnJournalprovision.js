...
var UserId   = localStorage.getItem('ginuserid');
    ...
    var Currencydatastore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
                  url: 'clsProvision.php',      // File to connect to
                  method: 'POST'
              }),
    ...
    function RefreshData(){
        ...
        VouNodatastore.load({
            ...
            callback: function(){
                cmbVouno.setValue("PJV"+VouNodatastore.getAt(0).get('con_value'));
            }
        });
        txtDebit.disable();
        txtCredit.disable();
