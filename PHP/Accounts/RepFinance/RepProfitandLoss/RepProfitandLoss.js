...
var RepProfitandLossFormPanel = new Ext.form.FormPanel({
...
//alert(d1);
		        ...
		        var rdchk=RepProfitandLossFormPanel.getForm().getValues()['chkabs'];
...
*/
		...
		border  :  false,
                ...
                columns :  1,
                items: [
                   {boxLabel: 'Profit and Loss - Detailed',  name: 'chkabs' , inputValue: 1 ,checked : true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						repopt=1;
                   ...
                   {boxLabel: 'Profit and Loss - Groupwise', name: 'chkabs' , inputValue: 2 ,checked : false,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						repopt=2;
                   ...
                   {boxLabel: 'Profit and Loss - Abstract', name: 'chkabs' , inputValue: 4 ,checked : false,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						repopt=3;
...
*/
     ...
     var RepProfitandLossWindow = new Ext.Window({
        height      : 450,
        width       : 530,
        items       : RepProfitandLossFormPanel,
        closable    : true,
        minimizable : true,
        maximizable : true,
        resizable   : false,
