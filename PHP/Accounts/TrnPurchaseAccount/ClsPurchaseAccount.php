 ...
 function getSearchPartylist()
    {
     ...
     //   $qry = "select * from massal_customer where led_type <> 'G' and cust_name like '%$party%' order by cust_name";
 ...
 function getPurVouNoDetails()
    {
        ...
        $finid    = $_POST['fincode'];
        $vouno    = $_POST['vouno'];
        $qry = "select * from  acc_direct_purchase , massal_customer where cust_code = pur_partycode and  pur_compcode = '$compcode' and pur_finid = '$finid' and pur_vouno = '$vouno'" ;
