        ...
        'cellclick' : function(Flxledger, rowIndex, cellIndex, e){
			...
			if ((selrow != null)){
				...
				var stkcnt  = 0;
                                ...
                                { 
                                    if (sel[k].data.led_code == ledcode)
                                    {
                                        stkcnt = stkcnt + 1;
                                    }
                                } 
...
//alert(ledname);
                        if (printtype == "PDF") 
window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepLedger.rptdesign&__format=pdf&' + paramnew, '_blank');
                        else
