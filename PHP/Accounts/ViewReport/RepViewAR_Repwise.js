...
var lblFrom = new Ext.form.Label({
    id: 'lblFrom',
    name: 'lblFrom',
    html: '<span style="color:#007bff; font-family:Helvetica; font-size:15px; font-weight:bold;">From</span>',
    width: 550
});

var lblTo = new Ext.form.Label({
    id: 'lblTo',
    name: 'lblTo',
    html: '<span style="color:#007bff; font-family:Helvetica; font-size:15px; font-weight:bold;">To</span>',
    width: 550
});


   var txtFrom1 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtFrom1',
        name        : 'txtFrom1',
        width       :  40,
   ...
   var txtTo1 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtTo1',
        name        : 'txtTo1',
        width       :  40,
//	readOnly : true,
        ...
        listeners:{
          change:function(){
              txtFrom2.setValue(Number(txtTo1.getValue())+1);
;
          },
          keyup:function(){
              txtFrom2.setValue(Number(txtTo1.getValue())+1);
   ...
   var txtFrom2 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtFrom2',
        name        : 'txtFrom2',
        width       :  40,
   ...
   var txtTo2 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtTo2',
        name        : 'txtTo2',
        width       :  40,
//	readOnly : true,
        ...
        listeners:{
          change:function(){
              txtFrom3.setValue(Number(txtTo2.getValue())+1);
;
          },
          keyup:function(){
              txtFrom3.setValue(Number(txtTo2.getValue())+1);
   ...
   var txtFrom3 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtFrom3',
        name        : 'txtFrom3',
        width       :  40,
   ...
   var txtTo3 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtTo3',
        name        : 'txtTo3',
        width       :  40,
//	readOnly : true,
        ...
        listeners:{
          change:function(){
              txtFrom4.setValue(Number(txtTo3.getValue())+1);
;
          },
          keyup:function(){
              txtFrom4.setValue(Number(txtTo3.getValue())+1);
   ...
   var txtFrom4 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtFrom4',
        name        : 'txtFrom4',
        width       :  40,
//	readOnly : true,
   ...
   var txtTo4 = new Ext.form.NumberField({
        fieldLabel  : '',
        id          : 'txtTo4',
        name        : 'txtTo4',
        width       :  40,
...
var optDueDateOpt = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optDueDateOpt',
        items: [
		{boxLabel: 'Payment Terms', name: 'optDueDateOpt', id:'optDueDate1', inputValue: 1,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
                                            OD_payterms =  'PT'
		...
		{boxLabel: 'Pay Terms + Grace Days', name: 'optDueDateOpt', id:'optDueDate2', inputValue: 2,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
                                          OD_payterms =  'PTGD'
...
var optRepOpt = new Ext.form.FieldSet({
 ...
 var loadBillsDetailsDatastore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        },['led_name', 'acctrail_led_code', 'acctrail_inv_no','acctrail_inv_date', 'acctrail_inv_value', 'acctrail_adj_value', 'acctrail_crdays','acctrail_gracedays', 'duedate', 'oddays','acctrail_amtmode','adjamt'])
    });
 ...
 var loadRepAgewiseDatastore = new Ext.data.Store({
      id: 'loadRepAgewiseDatastore',
      proxy: new Ext.data.HttpProxy({
                url: 'ClsViewStatements.php',      // File to connect to
                method: 'POST'
            }),
            baseParams:{task:"load_Rep_AR_Agewise"}, // this parameter asks for listing
      reader: new Ext.data.JsonReader({
                  // we tell the datastore where to get his data from
        root: 'results',
        totalProperty: 'total',
 ...
 var loadPartyAlldueDatastore = new Ext.data.Store({
      id: 'loadAllOverdueDatastore',
      proxy: new Ext.data.HttpProxy({
                url: 'ClsViewStatements.php',      // File to connect to
                method: 'POST'
            }),
            baseParams:{task:"loadParty_Alldue_Outstanding"}, // this parameter asks for listing
      reader: new Ext.data.JsonReader({
                  // we tell the datastore where to get his data from
        root: 'results',
        totalProperty: 'total',
...
//                                txtVouDate.setValue(Ext.util.Format.date(VouNoClickLoadDataStore.getAt(0).get('accref_voudate')),"d-m-Y");
//                                txtRefDate.setRawValue(Ext.util.Format.date(VouNoClickLoadDataStore.getAt(0).get('accref_voudate')),"d-m-Y");                         


                                for(var i=0;i<cnt;i++){
                                var custname=VouNoClickLoadDataStore.getAt(i).get('cust_name');
     ...
     var LedgerSelDataStore = new Ext.data.Store({
      ...
      var VouNoClickLoadDataStore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        },['accref_voudate','acctran_dbamt','acctran_cramt','cust_name','accref_payref_no','accref_payref_date','accref_narration','accref_seqno'])
    });
...
style: {
    ...
    [ 	 	
        ...
        {header: "Description " , dataIndex: 'grpname',sortable:false,width:250,align:'left', menuDisabled: true,
},
        {header: "Debit" , dataIndex: 'debit',sortable:false,width:100,align:'right', menuDisabled: true},
        {header: "Credit"  , dataIndex: 'credit',sortable:false,width:100,align:'right', menuDisabled: true},
    ],
...
style: {
    ...
    [ 	 	
        {header: "GRP Code" , dataIndex: 'grpcode',sortable:false,width:50,align:'left', menuDisabled: true,hidden:true},
        {header: "Customer " , dataIndex: 'grpname',sortable:false,width:320,align:'left', menuDisabled: true,
},
        ...
        {header: "SMS No"  , dataIndex: 'smsno',sortable:false,width:100,align:'center', menuDisabled: true,hidden : true},
        {header: "OD Msg(Y/N)"  , dataIndex: 'odmsg',sortable:false,width:100,align:'center', menuDisabled: true,hidden : true},
        {header: "MIN OD"  , dataIndex: 'minday',sortable:false,width:100,align:'center', menuDisabled: true,hidden : true},
        {header: "MAX OD"  , dataIndex: 'maxday',sortable:false,width:100,align:'center', menuDisabled: true,hidden : true},
    ],
    store:[], // store: GetGridDetailsDatastore,
    listeners:{	

       'cellDblclick': function (flxCustomer, rowIndex, cellIndex, e) {
                if (cellIndex == 5)
                {    
...
//alert(loadBillsDetailsDatastore.getAt(j).get('acctrail_gracedays'));
...
style: {
    ...
    [ 	 	
        ...
        {header: "Paymnt Terms", dataIndex: 'acctrail_crdays',sortable:false,width:80,align:'right', menuDisabled: true},
	        ...
	        flxld.getSelectionModel().selectAll();
		        ...
		        for(var i=0; i<selected_rows.length; i++)
		        {
		          var voouno=selected_rows[i].data.accref_vouno;
                          seqno = selected_rows[i].data.accref_seqno;
...
/*
    ...
    var btnOnlyBillsPrint = new Ext.Button({
        style: 'text-align:center;',
        text: "Only Bills Outstanding Print",
        width: 150,
	...
	borderStyle: 'solid',
        ...
        if (repopt =='All Outstanding')
         {
		    ...
		    var p4 = "&ledcode="+encodeURIComponent(ledcode);
		    var p5 = "&allopt="+encodeURIComponent(0);       
		    var p6 = "&grpcode="+encodeURIComponent(grpcode);       
                    var p7 = "&dueopt="+encodeURIComponent(OD_payterms); 
         ...
         else
        {
		    ...
		    var p4 = "&ledcode="+encodeURIComponent(ledcode);
 		    ...
 		    var param = (p1+p2+p3+p4) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwise_Overdue.rptdesign&__format=pdf&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwise_Overdue.rptdesign' + param, '_blank');	
         }
         }
...
*/
	...
	borderStyle: 'solid',
        ...
        if (repopt =='All Outstanding')
        {
		    ...
		    var p5 = "&maingroup="+encodeURIComponent(24);
		    var p6 = "&maingrpname="+encodeURIComponent('Sundry Debitors');
       
		    var p7 = "&fsdate=" + encodeURIComponent(finstartdate,"Y-m-d");

 		    var param = (p1+p2+p3+p4+p5+p6+p7) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding.rptdesign&__format=XLSX' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding.rptdesign' + param, '_blank');	
        }
        else
        {
		    ...
		    var p3 = "&dueopt="+encodeURIComponent(OD_payterms);   
 		    var param = (p1+p2+p3) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding.rptdesign&__format=XLSX' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding.rptdesign' + param, '_blank');
        }  
    ...
    var btnSubGrpPrint2Cr = new Ext.Button({
        style: 'text-align:center;',
        text: "RepWise Summary - Crore",
        width: 60,
        id: 'btnSubGrpPrint2Cr',
	...
	borderStyle: 'solid',
        ...
        if (repopt =='All Outstanding')
        {
		    var p1 = "&compcode="+encodeURIComponent(compcode);      
                    var p2 = "&asondate=" + encodeURIComponent(Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"));
		    var p3 = "&dueopt="+encodeURIComponent(OD_payterms);
		    var p4 = "&overdue="+encodeURIComponent(OVERDUE);

 		    var param = (p1+p2+p3+p4) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding_in_crore.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding_in_crore.rptdesign&__format=xls' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRepOutstanding_in_crore.rptdesign' + param, '_blank');	
        }
        else
        {
		    var p1 = "&compcode="+encodeURIComponent(compcode);      
		    ...
		    var p3 = "&dueopt="+encodeURIComponent(OD_payterms);   
 		    var param = (p1+p2+p3) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding_in_crore.rptdesign&__format=pdf&' + param, '_blank');
                    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding_in_crore.rptdesign&__format=xls' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_Overdue_Outstanding_in_crore.rptdesign' + param, '_blank');
        }  
    ...
    var btnAllPartyDetails = new Ext.Button({
        style: 'text-align:center;',
        text: "Partywise Summary ",
        width: 60,
        id: 'btnAllPartyDetails',
	...
	borderStyle: 'solid',
	 ...
	 var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    var p4 = "&ledcode="+encodeURIComponent(0);
                    var p5 = "&repcode="+encodeURIComponent(1000);
                    var p6 = "&overdue="+encodeURIComponent(OVERDUE);
                    var p7 = "&dueopt="+encodeURIComponent(OD_payterms);   
		    var param = (p1+p2+p3+p5+p6+p7) ;

		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_AllRep_Partywise_Outstanding.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_AllRep_Partywise_Outstanding.rptdesign&__format=xls&' + param, '_blank');
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_AllRep_Partywise_Outstanding.rptdesign' + param, '_blank');	
...
/*
		if (repopt =='All Outstanding')
		{
		    ...
		    var p3 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	          
		    var p4 = "&todate=" + encodeURIComponent(Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"));
		    var p5 = "&grpcode="+encodeURIComponent(24);
		    var p6 = "&fsdate=" + encodeURIComponent(finstartdate,"Y-m-d");

		    var param = (p1+p2+p3+p4+p5+p6) ;
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepPartywiseOutstanding.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepPartywiseOutstanding.rptdesign&__format=xls&' + param, '_blank');
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepPartywiseOutstanding.rptdesign' + param, '_blank');	
		 }
                 else
                 {
		    var p1 ="&compcode="+encodeURIComponent(compcode);      
		    var p2 = "&asondate=" + encodeURIComponent(Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"));
		    var p3 = "&repcode="+encodeURIComponent(1000);
		    var param = (p1+p2+p3) ;
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_AllParty_Overdue_Outstanding.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_AllParty_Overdue_Outstanding.rptdesign&__format=xls&' + param, '_blank');
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepRep_AllParty_Overdue_Outstanding.rptdesign' + param, '_blank');	
                 }
*/
           }
            }
...
//annadurai
    var btnAllPartyDetails_AllBills = new Ext.Button({
        style: 'text-align:center;',
        text: " All Party - Dr/Cr Doc.Wise",
        width: 60,
        id: 'btnAllPartyDetails',
...
alert(OD_payterms);
          ...
          var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    var p4 = "&ledcode="+encodeURIComponent(0);
		    var p5 = "&allopt="+encodeURIComponent(1);
		    var p6 = "&grpcode="+encodeURIComponent(0);
                    var p7 = "&dueopt="+encodeURIComponent(OD_payterms);   
 		    var param = (p1+p2+p3+p4+p5+p6+p7) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign&__format=xls&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign' + param, '_blank');	
    ...
    var btnAllParty_OnlyBills = new Ext.Button({
        style: 'text-align:center;',
        text: " Only -Bills",
        width: 60,
        id: 'btnAllParty_OnlyBills',
		...
		if (repopt =='All Outstanding')
		{
		    var p1 ="&compcode="+encodeURIComponent(compcode);      
	            var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-  d"));	   
                    var p3 = "&todate=" + encodeURIComponent(Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"));
		    var p4 = "&ledcode="+encodeURIComponent(0);
		    var p5 = "&allopt="+encodeURIComponent(2);
		    var p6 = "&grpcode="+encodeURIComponent(0);
 		    var param = (p1+p2+p3+p4+p5+p6) ;
                    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign&__format=pdf&' + param, '_blank');
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwise_Overdue.rptdesign&__format=xls&' + param, '_blank');
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwise_Overdue.rptdesign' + param, '_blank');	
                 }
           }
    ...
    var btnRepPartyAllDocwise = new Ext.Button({
        style: 'text-align:center;',
        text: "Rep-Party - All Documents ",
        width: 60, id: 'btnRepPartyAllDocwise',
...
//alert("You clicked All Details");
		if (repopt =='All Outstanding')
          ...
          var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    var p6 = "&grpcode="+encodeURIComponent(RepresentativeCode);
		    var p7 = "&dueopt="+encodeURIComponent(OD_payterms);
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign&__format=XLSX&' + param, '_blank');
                    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepARBillwiseOutstanding.rptdesign' + param, '_blank');	
...
*/
    ...
    var btnRepPartyBillwise = new Ext.Button({
        style: 'text-align:center;',
        text: "Rep-Party-Debit Balance(Inv&SDN) ",
	...
	borderStyle: 'solid',
	 ...
	 var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_Excel.rptdesign&__format=XLSX&' + param, '_blank');


}
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills.rptdesign' + param, '_blank');
    ...
    var btnRepPartyBillwise_with_precentage = new Ext.Button({
        style: 'text-align:center;',
        text: "Debit Balance(With %) ",
        width: 60, id: 'btnRepPartyBillwise',
	...
	borderStyle: 'solid',
	 ...
	 var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentage.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentageExcel.rptdesign&__format=XLSX&' + param, '_blank');

}
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentage.rptdesign' + param, '_blank');
	...
	borderStyle: 'solid',
	 ...
	 var p2 = "&fromdate=" + encodeURIComponent(Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"));	   
		    ...
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentage_Abstract.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
{
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentage_Abstract.rptdesign&__format=XLSX&' + param, '_blank');

}
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBills_with_percentage_Abstract.rptdesign' + param, '_blank');
    ...
    var btnRepPartyBillwise_Agewise = new Ext.Button({
        style: 'text-align:center;',
        text: "Debit Balance(Agewise) ",
        width: 60, id: 'btnRepPartyBillwise',
	...
	borderStyle: 'solid',
        ...
        listeners: {
          ...
          if (RepresentativeCode !=0)
          { 
		loadRepAgewiseDatastore.removeAll();
		loadRepAgewiseDatastore.load({
		 url: 'ClsViewStatements.php',
		        params: {
		    	task: 'load_Rep_AR_Agewise',
		        compcode  : compcode,
		        startdate : Ext.util.Format.date(monthstartdate.getValue(),"Y-m-d"), 
		        enddate   : Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"), 
		        enddate   : Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"), 
		        ...
		        overdue   : OVERDUE, 
		        ptgd      : OD_payterms,
		        agedays1  : Number(txtTo1.getValue()),
		        agedays2  : Number(txtTo2.getValue()),
		        agedays3  : Number(txtTo3.getValue()),
		        agedays4  : Number(txtTo4.getValue()),
			...
			callback:function()
			    ...
			    var p4 = "&ledcode="+encodeURIComponent(0);
		            ...
		            var p6 = "&overdue="+encodeURIComponent(OVERDUE);
		            var p7 = "&payterms="+encodeURIComponent(OD_payterms);
	       		    var p8 = "&agedays1="+encodeURIComponent(txtTo1.getValue());
	       		    var p9 = "&agedays2="+encodeURIComponent(txtTo2.getValue());
	       		    var p10 = "&agedays3="+encodeURIComponent(txtTo3.getValue());
	       		    var p11 = "&agedays4="+encodeURIComponent(txtTo4.getValue());

			    var param = (p1+p2+p3+p4+p5+p6+p7+p8+p9+p10+p11) ;

			    if (printtype == "PDF") 
			    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBillsAgewise.rptdesign&__format=pdf&' + param, '_blank');
			    else if (printtype == "XLS") 
	{
			    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBillsAgewise.rptdesign&__format=XLSX&' + param, '_blank');


	}
			    else
			    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingBillsAgewise.rptdesign' + param, '_blank');
    ...
    var btnRepPartyLetter = new Ext.Button({
        style: 'text-align:center;',
        text: "Rep-Party - Letter ",
        width: 60, id: 'btnRepPartyLetter',
	...
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    if (printtype == "PDF") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingLetter.rptdesign&__format=pdf&' + param, '_blank');
		    else if (printtype == "XLS") 
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingLetter.rptdesign&__format=xls&' + param, '_blank');
		    else
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRep_SelectiveRep_ARBillwise_OutstandingLetter.rptdesign' + param, '_blank');	
    ...
    var btnRepLedgerEmail = new Ext.Button({
        style: 'text-align:center;',
        text: "Ledger - Email ",
        width: 60, id: 'btnRepLedgerEmail',
		 ...
		 url: 'ClsViewStatements.php',
			...
			callback:function()
	 		   ...
	 		   { 
				   ...
				   debit   : dr,
				   credit  : cr ,
                                   smsno   : loadPartyOverdueDatastore.getAt(j).get('cust_smsno'),
                                   odmsg   : loadPartyOverdueDatastore.getAt(j).get('cust_overdue_msg'),
...
//        find_dates(m1);
	...
	txtLedgerCredit.setValue(0);
        ...
        flxDetails.getStore().removeAll();
	        ...
	        loadPartyAlldueDatastore.removeAll();
		loadPartyAlldueDatastore.load({
		 url: 'ClsViewStatements.php',
		        params: {
		    	task: 'loadParty_Alldue_Outstanding',
		        compcode:Gincompcode,
		        asondate: Ext.util.Format.date(monthenddate.getValue(),"Y-m-d"), 
                        repcode : RepresentativeCode,
                        overdue : OVERDUE,
			...
			callback:function()
	       		{
		           var cnt=loadPartyAlldueDatastore.getCount();
		           ...
		           for(var j=0; j<cnt; j++)
	 		   { 
		           if (loadPartyAlldueDatastore.getAt(j).get('balanceamt') != 0 )
		           {
				   var dr = 0;
				   var cr = 0;
		               if (Number(loadPartyAlldueDatastore.getAt(j).get('balanceamt')) > 0)
		                   dr = Ext.util.Format.number(loadPartyAlldueDatastore.getAt(j).get('balanceamt'),"0.00");
		               else
		                   cr = Ext.util.Format.number(Math.abs(loadPartyAlldueDatastore.getAt(j).get('balanceamt')),"0.00");
		               flxCustomer.getStore().insert(
		               flxCustomer.getStore().getCount(),
		               new dgrecord({	
	 			   grpcode : loadPartyAlldueDatastore.getAt(j).get('acctrail_led_code'),
				   grpname : loadPartyAlldueDatastore.getAt(j).get('ledname'),
				   debit   : dr,
				   credit  : cr ,
                                   smsno   : loadPartyAlldueDatastore.getAt(j).get('cust_smsno'),
                                   odmsg   : loadPartyAlldueDatastore.getAt(j).get('cust_overdue_msg'),
                                   minday  : loadPartyAlldueDatastore.getAt(j).get('minday'),
                                   maxday  : loadPartyAlldueDatastore.getAt(j).get('maxday'),
   ...
   var tabOverall = new Ext.TabPanel({
...

	{
...

		{
		    ...
		    width       : 200,
                    labelWidth  : 50,
		    items : [btnAllPartyDetails_AllBills]
		},
...
*/
		...
		},
		{
		    ...
		    width       : 220,
                    labelWidth  : 50,
		    items : [btnRepPartyBillwise_with_precentage]
		},
		{
		    xtype       : 'fieldset',
		    x           : 800,
		    ...
		    width       : 220,
                    labelWidth  : 50,
		    items : [btnRepPartyBillwise_with_precentage_Abstract]
		},
