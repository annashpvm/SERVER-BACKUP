...
var optRepOpt = new Ext.form.FieldSet({
 ...
 var loadBillsDetailsDatastore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        },['led_name', 'acctrail_led_code', 'acctrail_inv_no','acctrail_inv_date', 'acctrail_inv_value', 'acctrail_adj_value', 'acctrail_crdays', 'duedate', 'oddays','acctrail_amtmode'])
    });
 ...
 var loadRepOverdueDatastore = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },[ 'repr_name', 'repr_code', 'balanceamt'
 ...
 var loadPartyOverdueDatastore = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },[ 'ledname', 'acctrail_led_code', 'balanceamt','cust_smsno','cust_overdue_msg','minday','maxday'
...
function myFunction() {
 ...
 /*  var yearchangeDataStore = new Ext.data.Store({
  ...
  var MonthClickVocDataStore = new Ext.data.Store({
    ...
    var txtNos = new Ext.form.TextField({
        fieldLabel  : 'Nos',
        id          : 'txtNos',
        name        : 'txtNos',
        readOnly: true,
...
style: {
    ...
    [ 	 	
        {header: "GRP Code" , dataIndex: 'grpcode',sortable:false,width:50,align:'left', menuDisabled: true,hidden:true},
        {header: "Customer " , dataIndex: 'grpname',sortable:false,width:250,align:'left', menuDisabled: true,
},
        ...
        {header: "MIN OD"  , dataIndex: 'minday',sortable:false,width:100,align:'center', menuDisabled: true},
        {header: "MAX OD"  , dataIndex: 'maxday',sortable:false,width:100,align:'center', menuDisabled: true},
    ],
    store:[], // store: GetGridDetailsDatastore,
    listeners:{	
