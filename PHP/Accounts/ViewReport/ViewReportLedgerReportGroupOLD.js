...
var optprinttype = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optprinttype',
        items: [
		{boxLabel: 'PDF', name: 'optprinttype', id:'prtPDF', inputValue: 1,
			listeners:{
		...
		{boxLabel: 'Others', name: 'optprinttype', id:'optOTH', inputValue: 2,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
						printtype="OTHERS";
...
*/
  ...
  var MonthClickVocDataStore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        },['accref_vouno','accref_voudate','acctrail_inv_no','led_name','accref_payref_no','accref_narration','acctran_dbamt','acctran_cramt','accref_vou_type','partyledger'])
    });
...
style:{
        ...
        columns: [
            ...
            {header: "Account Name", dataIndex: 'accountledger',width:280,align:'left',sortable: false,defaultSortable: false,menuDisabled: true,
		renderer : function(value, meta ,record) {
		    var ledger=record.get('accountledger');
		    if(ledger!=='') {
			meta.style = "background-color:#FFDEAD;";
		    }else{
			meta.style = "background-color:#FFFFE0;";
            ...
            {header: "Voucher No", dataIndex: 'accref_vouno',width:100,align:'left',sortable: false,defaultSortable: false,menuDisabled: true,
/*
		renderer : function(value, meta ,record) {
...
*/
            ...
            {header: "Inv/Ref No", dataIndex: 'accref_payref_no',width:120,align:'left',sortable: false,defaultSortable: false,menuDisabled: true,align: 'center'},
            ...
            {header: "Debit", dataIndex: 'Debit',width:120,align:'left',sortable: false,defaultSortable: false,menuDisabled: true,align: 'right'},
            {header: "Credit", dataIndex: 'Credit',width:120,align:'left',sortable: false,defaultSortable: false,menuDisabled: true,align: 'right'},
