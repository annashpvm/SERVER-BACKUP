...
var UserId   = localStorage.getItem('ginuserid');
 ...
 var loadSearchSupplierlistDatastore = new Ext.data.Store({
      id: 'loadSearchSupplierlistDatastore',
//      autoLoad : true,
...
function ledgerSearch()
{
        ...
        loadSearchSupplierlistDatastore.removeAll();
        loadSearchSupplierlistDatastore.load({
		url: 'ClsViewStatements.php',
		params:
		{
			task   :"loadSearchSupplierlist",
   ...
   //             Ext.getCmp('tabAccPurchase').hide();   
          ...
          specialkey:function(f,e){
             ...
             if (e.getKey() == e.DOWN)
             {
        //       Ext.getCmp('flxSupplier').focus(false, 200);  
...
function party_flx_change()
{
	...
	if ((selrow != null)){
		...
		flxSupplier.getStore().filter('grpname', txtSupplier.getRawValue());   
		...
		flxSupplier.getStore().filter('grpname', '');   
	}
}
...
//            {header: "S.No  ", dataIndex: 'slno',sortable:true,width:30,align:'left'},    
		...
		{header: "Supplier Name", dataIndex: 'cust_name',sortable:true,width:330,align:'left'},
        ...
        store:loadSearchSupplierlistDatastore,
...
style: {
    ...
    listeners:{	
       ...
       'cellDblclick': function (flxSupplier, rowIndex, cellIndex, e) {
...
if (printtype == "PDF") 
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepAPGroupPartyOutstanding.rptdesign&__format=xls&' + param, '_blank');
                    else
