...
var UserId   = localStorage.getItem('ginuserid');
 ...
 var loadCustomerListDatastore = new Ext.data.Store({
      ...
      proxy: new Ext.data.HttpProxy({
            ...
            baseParams:{task:"loadLongPendingCustomerList"}, // this parameter asks for listing
	...
	'repr_name','l_custcode', 'l_custname'
      ]),
    });
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
       ...
       id: 'my-grid',  
		...
		{header: "Cust Code", dataIndex: 'l_custcode',sortable:true,width:90,align:'left', hidden: true},   
		{header: "Customer Name", dataIndex: 'l_custname',sortable:true,width:500,align:'left'},
   ...
   {
      if (txtPassword.getRawValue() == "longpending")
      {
   ...
   function LedgerSearch()
{
   ...
   function RefreshData(){
	...
	loadCustomerListDatastore.load({
          ...
          params:
       	  {
           task:"loadLongPendingCustomerList"
          }
	});
  ...
  function save_click()
{
	...
	else
	{
		...
		if (btn == 'yes')
			...
			Ext.Ajax.request({
                    	url: 'MasLongPendingSave.php',
	       	        params:
			{
                              saveflag    : saveflag,
                              custcode    : customercode, 
                              custname    : txtCustomerName.getRawValue(),
...
//save
	...
	height      : 600,
        width       : 1280,
        y           : 35,
        title       : 'ACCOUNTS - LONG PENDING CUSTOMER LIST',
