<?php
 ...
 function getreportgroup()
  ...
  function getLedgerList()
	...
	$r=mysql_query("select * from massal_customer , acc_group_master where  cust_type = 'G' and  cust_acc_group = grp_code  and cust_code > 0 order by cust_name");
  ...
  function getGroupList()
	...
	$r=mysql_query("select grp_name,grp_code from massal_customer , acc_group_master where  cust_acc_group = grp_code  and cust_code > 0 group by grp_name,grp_code order by  grp_name asc,grp_code");
