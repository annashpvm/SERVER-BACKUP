...
var RepBalanceSheetFormPanel = new Ext.form.FormPanel({
     ...
     bodyStyle:{"background-color":"#3399CC"},
        ...
        tbar: {
			...
			if (rdchk=="1" && rdchk1=="2")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBalanceSheetAbs.rptdesign'+test,  '_blank' );
			else if (rdchk1=="2")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBalanceSheet.rptdesign'+test,  '_blank' );
			else if (rdchk=="1")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBalanceSheetAbsWoProvision.rptdesign'+test,  '_blank' );
			else
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBalanceSheetWoProvision.rptdesign'+test,  '_blank' );
                    }
