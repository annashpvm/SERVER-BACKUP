   ...
   var fineddate = localStorage.getItem('gfineddate');
    ...
    var SubGroupsdatastore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '/SHVPM/Financials/clsFinancials4.php',
            method: 'POST'
        }),
    ...
    var tree = new Ext.tree.TreePanel({
        ...
        border: true,
        dataUrl: '/SHVPM/Financials/General/RepTrialBalance/clsTrialbal.php',
        root: {
            nodeType: 'async',
            text: 'Accounts',
            draggable: false,
        ...
        listeners: {
            ...
            expandnode: function (node) {
                ...
                Ext.Ajax.request({
                    url: '/SHVPM/Financials/General/RepTrialBalance/clsTrialbal.php',
                    params: {
                        grpparent: node.id
                    },
