...
var RepTrialBalanceFormPanel = new Ext.form.FormPanel({
     ...
     bodyStyle:{"background-color":"#3399CC"},
        ...
        tbar: {
			...
			if (rdchk=="1")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepProfitandLossAbs.rptdesign'+test,  '_blank' );
			else if (rdchk=="2")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepProfitandLoss.rptdesign'+test,  '_blank' );
			else
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepProfitandLossWoProvision.rptdesign'+test,  '_blank' );
                    }
