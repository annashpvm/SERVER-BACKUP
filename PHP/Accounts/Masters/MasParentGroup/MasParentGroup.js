...
var UserId   = localStorage.getItem('ginuserid');
 ...
 var loadParentGroupListDatastore = new Ext.data.Store({
      id: 'loadParentGroupListDatastore',
      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: 'ClsParentGroup.php',      // File to connect to
                method: 'POST'
            }),
  ...
  var loadledgerdatastore = new Ext.data.Store({
   ...
   function RefreshData(){
	...
	txtGroupName.setValue("");
        saveflag = "Add";
        accgrpcode =0;
        loadParentGroupListDatastore.removeAll();
	loadParentGroupListDatastore.load({
          url:'ClsParentGroup.php',
          params:
       	  {
           task:"loadParentGroup"
          }
	});
   };
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
       ...
       store:loadParentGroupListDatastore,
       ...
       listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			editrow = selrow;	
                        saveflag = "Edit";
			accgrpcode = selrow.get('grp_code');
...
//save
				...
				else
				{
					...
					if (btn == 'yes')
						{
						Ext.Ajax.request({
		                            	url: 'MasParentGroupSave.php',
                		       	        params:
						{
                                                        savetype   : saveflag,
                                                        accgrpcode : accgrpcode,   
