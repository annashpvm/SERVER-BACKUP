...
*/
   var btnAbsPrint = new Ext.Button({
	...
	//	    var p5 = "&gsttype=" + encodeURIComponent(gst_type);
 	 	   var param = (p1 + p2 + p3 + p4);   
                   if (printtype == "PDF") 
		   window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepHSNAbstractNew.rptdesign&__format=pdf'+ param); 
                   else if (printtype == "XLS") 
		   window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepHSNAbstractNew.rptdesign&__format=XLSX'+ param); 
                   else
		   window.open('http://10.0.0.251:8080/birt/frameset?__report=Accounts/AccRepHSNAbstractNew.rptdesign&'+ param); 
...
var gst_type ='R,U';
var optGSTtype = new Ext.form.FieldSet({
    xtype: 'fieldset',
  //  title: 'Report Format type',
    fieldLabel: '',
    layout : 'hbox',
    ...
    items: [
    {
        ...
        id: 'optGSTtype',
        items: [
		{boxLabel: 'ALL', name: 'optGSTtype', id:'opt_gsttype1', inputValue: 1,checked:true,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
					    gst_type ='R,U';
               ...
               {boxLabel: 'Registered(B2B)', name: 'optGSTtype', id:'opt_gsttype2', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
					    gst_type ='R';
		...
		{boxLabel: 'Un Registered(B2CS)', name: 'optGSTtype', id:'opt_gsttype3', inputValue: 2,
			listeners:{
				check:function(rb,checked){
					if(checked==true){
			 	    gst_type ='U';
...
var columnHeaderGroup = new Ext.ux.grid.ColumnHeaderGroup({
    rows: [[
        {header: '', colspan: 1}, // For "SUPPLY"
        {header: 'Supply Info', colspan: 2, align: 'center'},
        {header: '', colspan: 13} // Rest of the columns
    ]]
});
*/
