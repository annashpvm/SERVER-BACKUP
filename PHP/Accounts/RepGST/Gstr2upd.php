...
$todate   = $_REQUEST['todate'];
 ...
 where  accref_vou_type  in ('PSP','PSC','PLW','PIW','PPF','PDE','PUR') and  accref_comp_code = '$compcode' and accref_finid = '$finid'  and accref_voudate between '$fromdate' and  '$todate'";  
