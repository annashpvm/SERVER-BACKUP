...
thead th { text-align:left; background:grey; color:white}
  ...
  <input type="number"  min="2026"  max ="2050" id="repyear" name="repyear" ><br><br>
  <label for="Finyear">Fin Year:</label>
  <input type="text" name="finyear" value="<?php echo htmlspecialchars($invfin); ?>" readonly style="width:80px;><br><br>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (invfin) {
        document.getElementById("finyear").value = invfin;
    }
});
</script>
