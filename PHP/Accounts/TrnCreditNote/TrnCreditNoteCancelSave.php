...
//echo "<br>";
   ...
   $query2  = "update  acc_dbcrnote_trailer set dbcrt_grossvalue = 0 , dbcrt_value = 0, dbcrt_igstvalue = 0, dbcrt_cgstvalue = 0, dbcrt_sgstvalue = 0, dbcrt_igstper =0 , dbcrt_cgstper=0, dbcrt_sgstper=0, dbcrt_tcsvalue =0, dbcrt_tcsper =0, dbcrt_otheramt = 0 , dbcrt_rounding = 0 ,dbcrt_taxable =0  where dbcrt_seqno = $dncrseqno";
