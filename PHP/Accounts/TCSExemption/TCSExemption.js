...
var UserId   = localStorage.getItem('ginuserid');
 ...
 var loadTCSExemptionListDatastore = new Ext.data.Store({
      id: 'loadTCSExemptionListDatastore',
      autoLoad : true,
      proxy: new Ext.data.HttpProxy({
                url: 'clsTCSExemption.php',      // File to connect to
                method: 'POST'
            }),
	...
	'cust_code','cust_ref','cust_tcs_applied'
...
var cmbCustomer = new Ext.form.ComboBox({
   ...
   function RefreshData(){
        ...
        loadTCSExemptionListDatastore.removeAll();
	loadTCSExemptionListDatastore.load({
          url:'clsTCSExemption.php',
          params:
       	  {
   ...
   var flxDetail = new Ext.grid.EditorGridPanel({
       ...
       id: 'my-grid',  
		...
		{header: "TCS APPLIED", dataIndex: 'cust_tcs_applied',sortable:true,width:100,align:'left'},

        ],
       store:loadTCSExemptionListDatastore,
       ...
       listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
			...
			{
				if (selected_rows[i].data.cust_tcs_applied == 'N')
                                    flag = 'N';
                                else                                   
                                    flag = 'Y';
                                             
                               	colname = 'cust_tcs_applied';
				if (flag == 'N')
				{
   ...
   var MasTCSExemptionpanel = new Ext.FormPanel({
        renderTo    : Ext.getBody(),
        xtype       : 'form',
        title       : 'TCS EXEMPTION LIST',
        header      : false,
        width       : 1260,	
...
//save
				...
				else
				{
					...
					if (btn == 'yes')
                                            	...
                                            	if (obj['success'] === "true") 
						{
						    ...
						    MasTCSExemptionpanel.getForm().reset();
							RefreshData();
    ...
    var MasTCSExemptionWindow = new Ext.Window({
	height      : 600,
        width       : 1280,
        y           : 35,
        title       : 'TCS EXEMPTION LIST',
        items       : MasTCSExemptionpanel,
        layout      : 'fit',
