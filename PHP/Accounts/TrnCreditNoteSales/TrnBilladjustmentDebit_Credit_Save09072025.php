...
// echo "<br>";
        ...
        for($i=0;$i<$rowCreditNote;$i++){
            ...
            #Insert AccTrail
               if ($ledtype != 'G')
               {
               $querya3 = "call acc_sp_trn_insacc_trail ('$ref_docseqno','$slno','$vouno', '$voudate', '$totamt' ,'0' ,'$ledseq' ,'$amtmode','0','0')";
