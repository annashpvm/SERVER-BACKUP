        ...
        listeners: {
		    ...
		    var selrow = sm.getSelected();
			    ...
			    editrow  = selrow;
                            ...
                            txtgstvalue.setRawValue(accname2);
                            ...
                            cmbAcctname.setValue(accledcode);
...
//alert(seqno);
                        ...
                        if (Ext.util.Format.date(dtpVoudate.getValue(), "Y-m-d") < Ext.util.Format.date(fromdate, "Y-m-d")) {
                            ...
                            Ext.MessageBox.alert("Expenses", "The Transactions Debit and Credit Amount are not  Equal");
                               ...
                               if ((taxtypenew == "CS" ) && (cmbCGSTledger.getValue() == '' || cmbSGSTledger.getValue() == ''))
                               {  
...
//edit 
			 ...
			 var p4 = "&vounoto=" + encodeURIComponent(v4);
                ...
                window.open('http://10.0.0.251:8080/birt/frameset?__report=accounts/AccRepVoucherprint.rptdesign' + param, '_blank'); 
                        }
                        }
                    }
                }, '-',
