...
if ($gstFlaggrn === "Add") {
	 ...
	 $query3= "call sprm_ins_receipt_header('$rech_seqno','$compcode','$finid','$rech_no','$supcode','$ordseqno','$grndate','$wtcardno','$areacode','$truck','$frtype','$itemval',  '$sgstper','$sgstamt','$cgstper','$cgstamt','$igstper','$igstamt','$tcsper','$tcsamt','$freight','$otheramt','$roundoff','$totamt','$billno',  '$billdate','$billval',	'$usrcode','$entrydate','$gateentryno','$gatedate',0)";
...
//	$recsts=$griddet[$i]['recsts'];
	...
	$lotcode=$griddet[$i]['lotcode'];
	 ...
	 $query4= "insert into trnrm_receipt_trailer values('$rech_seqno','$sno','$itemcode','$lotcode','$billqty','$millqty','$itemrate','$tareqty','$moisper','$moisqty','$lifelessqty','$rejqty', '$totdedqty','$degradeqty','$grnqty','$itemcode','$itemvalue','$costrate','$costvalue','',upper('$remarks'))";
