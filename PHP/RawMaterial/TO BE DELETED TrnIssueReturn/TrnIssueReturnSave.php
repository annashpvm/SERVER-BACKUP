...
$retval =$_POST['retval'];
$retunit =$_POST['retunit'];
$rettype ='Y';
$retremarks= $_POST['retremarks'];
$usrcode= $_POST['usrcode'];
 ...
 $query3= " call sprm_ins_issret_header ('$issretseqno','$retcompcode','$retfincode','$issretno','$rettype','$retdate','$retval','$retremarks','$retunit','$usrcode','$retdate')";
 $result3=mysql_query($query3);
...
$billqty = $griddet[$i]['actqty'];
 ...
 $query4= " call sprm_ins_issret_trailer_new ('$issretseqno','$isrt_seqno','$lotseq','$itemseq','$cost','$vartype','$retqty','$retrate','$retbags','$retval',
'$retcompcode','$retfincode','$billqty')";
