Ext.onReady(function(){
 ...
 var loadMonthGRNData = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },[ 'rech_no' , 'rech_date','sup_refname','itmh_name','rect_grnqty','rect_itemvalue' 
 ...
 var loadMonthPOData = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },[ 'ordh_no' , 'ordh_date','sup_refname','itmh_name','ordt_qty','ordt_item_value' 
...
var optprinttype = new Ext.form.FieldSet({
 ...
 var cmbReport = new Ext.form.ComboBox({
	...
	emptyText       : '--Select Report Type--',
        mode            : 'local',
        store           : [['1','PURCHASE ORDER'],['2','GRN CUM INVOICE'],['3','ISSUE SLIP'],['4','PURCHASE ORDER - Annexure']],
        forceSelection  : true,
        triggerAction   : 'all',
        selectOnFocus   : false, 
        editable        : false,
...
var flxGRN = new Ext.grid.EditorGridPanel({
    ...
    [ 	 	
        ...
        {header: "Date" , dataIndex: 'rech_date',sortable:false,width:80,align:'left', menuDisabled: true},
        {header: "Supplier" , dataIndex: 'sup_refname',sortable:false,width:160,align:'left', menuDisabled: true},
        {header: "Item" , dataIndex: 'itmh_name',sortable:false,width:200,align:'left', menuDisabled: true},
...
ReppreprintWindow.hide();
	...
	x	    : 10,
        y           : 35,
        title       : 'RAW MATERIAL Voucher Printing',
