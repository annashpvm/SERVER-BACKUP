...
*/
 ...
 function getDatewiseWBDetails()
	...
	$startdate= $_POST['startdate'];
        ...
        $r=mysql_query("select *, DATE_FORMAT(t_wb_date, '%d-%m-%Y') as ticketdate,case when t_wb_1st_loadtype = 'E' then t_wb_1st_weight else t_wb_2nd_weight end as emptywt,case when t_wb_1st_loadtype = 'L' then t_wb_1st_weight else t_wb_2nd_weight end as loadwt , DATE_FORMAT(t_wb_1st_time, '%d-%m-%Y %H:%i:%s') as t_wb_1st_time1  ,
