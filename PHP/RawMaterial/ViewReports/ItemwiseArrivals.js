...
//    y:100,
    ...
    listeners:{	
		...
		var selrow = sm.getSelected();
            ...
            lblParty.setText("Detail for  : " + selrow.get('sup_refname') );
            lblParty2.setText("Detail for  : " + selrow.get('sup_refname') );
...
var btnProcess = new Ext.Button({
	...
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRMItemwiseArrivals.rptdesign&__format=XLSX&' + param, '_blank');
                    else
	...
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRMItem_PartywiseArrivals.rptdesign&__format=XLSX&' + param, '_blank');
                    else
	...
	borderStyle: 'solid',
        ...
        listeners: {
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRMItem_Party_GRNwiseArrivals.rptdesign&__format=XLSX&' + param, '_blank');
                    else
