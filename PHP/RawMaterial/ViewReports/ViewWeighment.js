...
if (printtype == "PDF") 
	    ...
	    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRM_Ticket_Datewise.rptdesign&__format=XLSX&' + param, '_blank');
            else
...
if (printtype == "PDF") 
	    ...
	    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRM_Ticket_Partywise.rptdesign&__format=XLSX&' + param, '_blank');
            else
...
if (printtype == "PDF") 
	    ...
	    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/RepRM_Ticket_Itemwise.rptdesign&__format=XLSX&' + param, '_blank');
            else
