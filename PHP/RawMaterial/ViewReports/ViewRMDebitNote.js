...
var lblDetail1 = new Ext.form.Label({
 ...
 var loadDebitNoteListDateDataStore = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
        ...
        totalProperty: 'total',
        id: 'id' 
      },['sup_refname','qc_fuel_debitnote_date','qc_fuel_debitnote_no','qc_fuel_debitamount','qc_fuel_entryno','qc_fuel_entrydate','qc_fuel_ticketno','qc_fuel_truck'
 ]),
    });
...
var flxDebitNote = new Ext.grid.EditorGridPanel({
    ...
    [ 	 
        ...
        {header: "Supplier",  dataIndex: 'sup_refname',sortable:false,width:300,align:'left' },
        {header: "Date",  dataIndex: 'qc_fuel_debitnote_date',sortable:false,width:100,align:'left'  },
        {header: "DN No."  , dataIndex: 'qc_fuel_debitnote_no',sortable:false,width:90,align:'center'},
