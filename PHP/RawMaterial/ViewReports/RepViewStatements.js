...
var flxMonth = new Ext.grid.EditorGridPanel({
 ...
 if (printtype == "PDF") 
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_Party_GRNwiseArrivals.rptdesign&__format=XLSX&' + param, '_blank');
                    else
 ...
 if (printtype == "PDF") 
		    ...
		    window.open('http://10.0.0.251:8080/birt/frameset?__report=Rawmaterial/repRM_PartywiseArrivals.rptdesign&__format=XLSX&' + param, '_blank');
                    else
