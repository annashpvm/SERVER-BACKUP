...
$rech_seqno=$edgrnno;
	 ...
	 $resultjk= mysqli_query($conn, $queryjk);
	 $recjk = mysqli_fetch_array($resultjk);
...
//echo $query11;
      ...
      $query14= "call sprm_upd_receipt_header('$rech_seqno','$grndate','$wtcardno','$areacode' ,'$crdays','$truck','$frtype', '$itemval','$sgstper', '$sgstamt','$cgstper','$cgstamt','$igstper','$igstamt','$tcsper','$tcsamt','$freight', '$otheramt','$roundoff','$totamt','$billno','$billdate', '$billval','$gateentryno','$gatedate','$roundneed')";
...
//	$recsts=$griddet[$i]['recsts'];
	...
	$lotcode=$griddet[$i]['lotcode'];
	 ...
	 $query4= "insert into trnrm_receipt_trailer values('$rech_seqno','$sno','$itemcode','$lotcode','$billqty','$millqty','$itemrate','$tareqty','$moisper','$moisqty',0,0,'$lifelessqty','$rejqty', '$totdedqty','$degradeqty','$grnqty','$itemcode','$itemvalue','$costrate','$costvalue','',upper('$remarks'))";


	 $query4= "insert into trnrm_receipt_trailer values('$rech_seqno','$sno','$itemcode','$lotcode','$billqty','$millqty','$itemrate','$tareqty','$moisper','$moisqty',0,0,'$lifelessqty','$rejqty', '$totdedqty','$degradeqty','$grnqty','$itemcode','$itemvalue','$costrate','$costvalue','',upper('$remarks') ,'0','0','0','0','0','0')";
...
//   echo $query7;
	...
	if ($degrcnt > 0)
	{
		...
		$query8 ="insert into trnrm_receipt_trailer values('$rech_seqno','$sno','$degrtoitemcode','$degrlotcode','0','0','$degritemrate','0','0','0','0','0','0','0','0','0','$drdegrqty',
'$degritemcode','$degritemvalue','$degritemrate','$degritemvalue','','$degrremarks','0','0','0','0','0','0')";
