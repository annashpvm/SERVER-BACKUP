...
/*
	...
	$lotno =  1;// $griddet[$i]['lotno'];
	$billqty = (float)$griddet[$i]['ticketwt'];
	$millqty = (float)$griddet[$i]['ticketwt'];
	$itemrate= (float)$griddet[$i]['unitrate'];
...
//	$recsts=$griddet[$i]['recsts'];
	$remarks= left($griddet[$i]['remarks'],150);
	...
	$remarks         = substr(trim($griddet[$i]['remarks']),0,150);
	$lotcode         = 1;
