...
'rect_mois_for_material','rect_mois_for_qty', 'rect_lifeless_per', 'rect_reject_per', 'rect_ticketno','rect_mat_pack_type'      ]),
    });
...
var flxDetail = new Ext.grid.EditorGridPanel({
    ...
    [
        ...
        {header: "Rate", dataIndex: 'unitrate',sortable:true,width:100,align:'left',
        editor: {
            xtype: 'numberfield',
            allowBlank: true,
            enableKeyEvents: true,
    ...
    listeners:{	
        'cellclick' : function(flxDesc, rowIndex, cellIndex, e){
		     ...
		     if (btn === 'yes')
				...
				txtRate.setRawValue(selrow.get('unitrate'));
