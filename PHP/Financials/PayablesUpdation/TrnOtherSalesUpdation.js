...
'salledcode', 'salledname', 'cgstledcode', 'cgstledname','sgstledcode', 'sgstledname', 'igstledcode', 'igstledname'	
...
//alert(partyledcode);
				    ...
				    {                         
						  ...
						  salesledcode : loadGRNdetailsStore.getAt(j).get('salledcode'),
						  salesledname : loadGRNdetailsStore.getAt(j).get('salledname'),
    ...
    function RefreshData() {
                 ...
                 flxAccounts.getStore().removeAll();
                  VouNodatastore.load({
                        ...
                        callback: function(){
                            txtVouNo.setRawValue("OS"+VouNodatastore.getAt(0).get('con_value'));
                        }
                    }); 
