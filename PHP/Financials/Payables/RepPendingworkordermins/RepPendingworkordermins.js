...
//                                var compcode=1;
                                ...
                                if (rptype=="OP1") {
//                                    if(gstfincompcode==1){
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/acc_pending_womin_details.rptdesign' + test,  '_blank' );    
  //                                  }else{
//window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/acc_pending_womin_details_new.rptdesign' + test,  '_blank' );
//                                    }
                                }
                                else if (rptype=="OP2") {
                                    if(gstfincompcode==1){
                                        window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/acc_consolidatepending_womin_details.rptdesign' + test,  '_blank' );    
                                    }else{
                                        window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/acc_consolidatepending_womin_details_new.rptdesign' + test,  '_blank' );
                                    }
                                }                                
                                else if (rptype=="OP3") {
                                    window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/acc_madeups_pending_womin_details.rptdesign' + test,  '_blank' );
                                }                                
                            }
                         }
                    }
