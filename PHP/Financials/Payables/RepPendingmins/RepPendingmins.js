...
//                    var finid=20;
		...
		var fg = "&flag=" + encodeURIComponent(gstseloption);
			...
			if (gstrpttype=="C")
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepConsolidatedPendingMINDetails.rptdesign'+test,  '_blank' );
			}
			...
			var vcode = "&vencode="+encodeURIComponent(vencode);
			var test = (comp+fin+fd+td+sts+top+vcode) ;
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPartywisePendingMINDetails.rptdesign'+test,  '_blank' );
			}
			else
			{
			...
			if (GinCompcode=="1")
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetails.rptdesign'+test,  '_blank' );
			}
			else
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetailsNew.rptdesign'+test,  '_blank' );
			}
			}
                     }
			else if (gstoption=="Y")
...
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetailsYarn.rptdesign'+test,  '_blank' );
                     }
                    else if (gstoption=="F")
                     {
			if (gstrpttype=="P")
...
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetailsFabric.rptdesign'+test,  '_blank' );
                     }
		 else if (gstoption=="M")
                     {
			if (GinCompcode=="1")
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetailsMadeups.rptdesign'+test,  '_blank' );
			}
			else
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepPendingMINDetailsMadeupsNew.rptdesign'+test,  '_blank' );
			}
                     }
                    }
                    }
