...
Ext.onReady(function () {
    ...
    var Finyear = localStorage.getItem('accfinyear');
	...
	flxDetails1.getStore().removeAll();
        ...
        for (var b = 0; b < Row1; b++)
        {
            BIssuewt = '';
            Inwardseqno = sel1[b].data.ValueDef;
			BIssuewtnew = Ext.util.Format.number(Number(BIssuewtnew) + Number(sel1[b].data.Value), '0.000');

 		if (Inwardseqno === sel1[b].data.ValueDef) {
                    cnt = cnt + 1;
                }

            flxDetails1.getSelectionModel().selectAll();
            var selrows = flxDetails1.getSelectionModel().getCount();
            var sel = flxDetails1.getSelectionModel().getSelections();
            var cnt = 0;
            for (var i = 0; i < selrows; i++) {
                if (sel[i].data.ValueDef === Inwardseqno) {
                    cnt = cnt + 1;
			BIssuewt = Ext.util.Format.number(Number(BIssuewt) + Number(sel[i].data.Value), '0.000');
                }
            }
            if (cnt > 0) {
            } else {
                flxDetails1.getStore().insert(
                        ...
                        new dgrecord({
                            ...
                            AccountName: '',
                            DebitAmtt: BIssuewt,
                            ValueDef: Inwardseqno
                        })
                        );
            }

            //sel1[b].set('Value', BIssuewt);
        }
    ...
    function Purchasevendor() {
        ...
        VendornameDataStore.load({
            url: '/Financials/Payables/TrnPurchases/clsFinancials2.php',
            params: {
                task: 'VendorName',
                prefix: prefix,
                gincompany: compcode,
                                                                    ...
                                                                    if (Number(itempurret) > 0) {
                                                                        if (purinvfreightflag === "Y") {
                                                                            ...
                                                                            StoreDetailsMinTrailDataStore123.load({
                                                                                url: '/SHVPM/Financials/Payables/TrnPurchases/clsFinancials2.php',
                                                                                params: {
...
//Madeups Function Stores//
    var StorePurchaseMadupsDataStore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '/SHVPM/Financials/Payables/TrnPurchases/clsFinancials2.php', // File to connect to
            method: 'POST'
        }),
...
//Workorder//
    var WorkorderMinHeaderDataStore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '/Financials/Payables/TrnPurchases/clsFinancials2.php', // File to connect to
            method: 'POST'
        }),
...
//Stores//
    ...
    var StorePurchaseDataStore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            'purinv_cgst',
            'purinv_sgst',
            'purinv_igst', 'purinv_freight_flag'
        ])
    });
    ...
    var MinlenDataStore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        }, ['discount', 'tngst', 'cst', 'exciseduty', 'AddExduty_val', 'other1', 'min_clearing', 'min_licence', 'min_freight_acctflag', 'freight', 'min_cgstvalue', 'min_sgstvalue', 'min_igstvalue', 'min_roundoffvalue'])
    });
...
//Yarn//
    var YarnPurchaseDataStore = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            'Yarn_Inv_discount', 'Yarn_Inv_Round_amt', 'Yarn_Inv_Date1', 'Yarn_Inward_DC_date1', 'Yarn_Inv_con_charges', 'Yarn_Inv_freight_acctflag', 'Yarn_Inv_Insurance_value', 'yarn_igst', 'yarn_sgst', 'yarn_cgst'
        ])
    });
...
//YarnEnd//
    ...
    var optDepartment = new Ext.form.FieldSet({
        ...
        height: 180,
        border: false,
        items: [{xtype: 'radiogroup', columns: 2, rows: 1, id: 'optDepartment',
                items: [
                    ...
                    {boxLabel: 'Yarn', name: 'optDept', inputValue: 2, id: 'idyarn',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Cotton', name: 'optDept', inputValue: 3, id: 'idcotton',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'BWH', name: 'optDept', inputValue: 4, hidden: true, id: 'idbwh',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'IFD M/c', name: 'optDept', inputValue: 5, id: 'idifd',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Import Yarn', name: 'optDept', inputValue: 6, id: 'idimportyarn',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Work Order', name: 'optDept', inputValue: 7, id: 'idwo',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'VM Work Order', name: 'optDept', inputValue: 8, hidden: true, id: 'idvmwo',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Work Order IFD', name: 'optDept', inputValue: 15, id: 'Woifd', hidden: true,
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Terry', name: 'optDept', inputValue: 9, id: 'idterry',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Madeups', name: 'optDept', inputValue: 10, id: 'idmadeups',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Madeups WorkOrder', name: 'optDept', inputValue: 11, id: 'idmadeupwo', hidden: true,
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Yarn Fibre', name: 'optDept', inputValue: 12, hidden: true, id: 'idyarnfibre',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Trigger', name: 'optDept', inputValue: 13, hidden: true, id: 'idtrigger',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    {boxLabel: 'Fibre', name: 'optDept', inputValue: 13, id: 'idfibre',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    }, {boxLabel: 'Fabric', name: 'optDept', inputValue: 14, id: 'idfabric', hidden: true,
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                ...
                for (var i = 0; i < selected_rows.length; i++) {
                    GroupAgsDataStore.load({
                        ...
                        callback: function () {
                            ...
                            {
                                if (compcode === '1') {
                                    if (selected_rows[i].data.itemname !== 'CGST INPUT' && selected_rows[i].data.itemname !== 'SGST INPUT' && selected_rows[i].data.itemname !== 'IGST INPUT') {
    ...
    var btnAdd = new Ext.Button({
        ...
        listeners: {
            click: function () {
                ...
                } else if (txtDebitVal.getRawValue() == "") {
                    Ext.Msg.alert("Alert", "Enter Debit Value!")
                } else if (txtAmt.getRawValue() == "") {
                                ...
                                Ext.MessageBox.show({
                                    ...
                                    fn: function (btn) {
                                        if (btn === 'yes') {
                                            ...
                                            Ext.Ajax.request({
                                                url: '/Financials/Payables/TrnPurchases/TrnPurchaseSave.php',
                                                params: {
                                                ...
                                                callback: function (options, success, response)
                                                {
                                                    ...
                                                    if (obj['success'] === "true") {
                                                        if (tdsinclude == 1) {
                                                            saveclear1();
                                                            Ext.MessageBox.show({
                                                                title: 'Accounts Save Alert',
                                                                icon: Ext.Msg.QUESTION,
                                                                buttons: Ext.MessageBox.OK,
                                                                msg: 'Saved Vocher No :-' + obj['msg'] + " - And -" + txtVocherNo.getRawValue(),
                                                                fn: function (btn) {
                                                                    if (btn === 'ok') {
                                                                        saveclear();
                                                                    } else {
                                                            ...
                                                            Ext.MessageBox.show({
                                                                ...
                                                                icon: Ext.Msg.QUESTION,
                                                                buttons: Ext.MessageBox.OK,
                                                                msg: 'Saved Vocher No :-' + txtVocherNo.getRawValue(),
                                                                fn: function (btn) {
                                                                    if (btn === 'ok') {
                                                                        saveclear();
                                                                    } else {
    ...
    var PurchaseEntryFormPanel = new Ext.FormPanel({
        ...
        bodyStyle: {"background-color": "#4682B4"},
        style: {
            'color': 'white',
            'style': 'Helvetica',
            'font-size': '15px', 'font-weight': 'bold'
    ...
    function RefreshData() {
        ...
        if (localStorage.getItem('acccompcode') == 1)
        {
            ...
            Ext.getCmp('idyarnfibre').setVisible(false);
            ...
            Ext.getCmp('idbwh').setVisible(false);
