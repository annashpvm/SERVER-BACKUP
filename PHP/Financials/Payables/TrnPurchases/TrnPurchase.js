    ...
    var optDepartment = new Ext.form.FieldSet({
        ...
        items: [{xtype: 'radiogroup', columns: 2, rows: 1, id: 'optDepartment',
                items: [
                    ...
                    {boxLabel: 'Import Coal', name: 'optDept', inputValue: 4, hidden: false, id: 'idimpcoal',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
               ...
               /*     {boxLabel: 'IFD M/c', name: 'optDept', inputValue: 5, id: 'idifd',
                    ...
                    {boxLabel: 'Yarn Fibre', name: 'optDept', inputValue: 12, hidden: true, id: 'idcoalfibre',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
                    ...
                    },{boxLabel: 'Chemicals', name: 'optDept', inputValue: 15, id: 'idchem',
                        listeners: {
                            check: function (rb, checked) {
                                if (checked == true) {
                                    flxDetails.getStore().removeAll();
