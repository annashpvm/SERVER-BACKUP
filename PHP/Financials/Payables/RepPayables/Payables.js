...
var optRpttype = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optRpttype',
        items: [
		{boxLabel: 'AP - Register', name: 'optRpttype', id:'optAPregister', inputValue: 1,checked:false,
			listeners:{
...
{                                
                                window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/RepAccPayables.rptdesign' + param,  '_blank' );     
}
else
{
