...
var todate = new Ext.form.DateField({
   ...
   var fp = new Ext.FormPanel({
        ...
        xtype       : 'form',
        title       : 'MIN LIST',bodyStyle:{"background-color":"#3399CC"},
        width       : 420,
        height      : 300,
        x           : 25,
        y           : 25,
	...
	tbar: {
			...
			{
		     var v=Ext.getCmp('cmbvendor').getValue();
			}
		     ...
		     var vd = "&vend=" + encodeURIComponent(v);
		     var cp = "&comp=" + encodeURIComponent(c);
		     var param = (fd + td + vd + cp) ;   
//			if (rad=="1")                    
			//{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepStoresVendMinLIst.rptdesign' + param, '_blank');
//			}
			//else
//			{
///window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepStoresVendMinLIst.rptdesign' + param, '_blank');
...
border  :  false,
                ...
                columns :  2,
                items: [
                    {boxLabel: 'Min', name: 'opt', inputValue: '1', checked: true},
                    {boxLabel: 'Repair', name: 'opt', inputValue: '2'}
                ]
            }
        ]
            },
...
border  :  false,
                ...
                columns : 5,
                items: [
                    {boxLabel: 'All', name: 'reptype', inputValue: '1', checked: true},
                    {boxLabel: 'Selective', name: 'reptype', inputValue: '2'}
                ]
            }
        ]
            },	
