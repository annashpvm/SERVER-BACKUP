...
if ($conval > 0) {
    $querya2 = "call acc_sp_trn_insacc_ref('$ginaccrefseq','$vouno','$compcode','$finid','$voudate',
                'DN','$bankname','$paymode','$payno','$paydate','$narration',0,0);";
    ...
    if ($output == "N") {
        if ($compcode == 90) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'111',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'191',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33200',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
            ...
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34192',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'34193',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);

                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'341
                    94',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        } else if ($compcode == 4) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33204',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'33205',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33203',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        } else if ($compcode == 8) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34977',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'34979',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34975',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        }
        ...
        if ($compcode == 1) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33141',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'33143',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33142',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        } else if ($compcode == 11) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    ...
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34194',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        } else if ($compcode == 4) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33163',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'33165',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33164',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        } else if ($compcode == 8) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34978',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'34980',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax2 = mysqli_query($conn, $queryatax2);
                } else if ($taxtype == "I") {
                    $queryatax3 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'34976',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax3 = mysqli_query($conn, $queryatax3);
                }
            }
        }
...
#Insert AccDbcrNoteHeader
    ...
    if ($billmode == 'D') {
        for ($i = 0; $i < $rowcnt; $i++) {
            ...
            if ($taxtype == "CS") {
                $querya7 = "call acc_sp_insdbcrnotetrailernew('$gindbcrseq','$slno','$invno','$invdate','$totalval','$compcode','$dnnew','0','$TAXVALnew','$TAXVALnew');";
                $resulta7 = mysqli_query($conn, $querya7);
            } else if ($taxtype == "I") {
                $querya7 = "call acc_sp_insdbcrnotetrailernew('$gindbcrseq','$slno','$invno','$invdate','$totalval','$compcode','$dnnew','$TAXVALnew','0','0');";
                $resulta7 = mysqli_query($conn, $querya7);
            }
        ...
        #Insert AccTrail
        $querya5 = "call acc_sp_trn_insacc_trail('$ginaccrefseq','$slno','$vouno','$voudate','$totalval',0,'$party');";
        $resulta5 = mysqli_query($conn, $querya5);

        #Insert AccDbcrNoteTrailer	
        if ($taxtype == "CS") {
            $querya7 = "call acc_sp_insdbcrnotetrailernew('$gindbcrseq','$slno','',curdate(),'$totalval','$compcode','$dnnew','0','$TAXVALnew','$TAXVALnew');";
            $resulta7 = mysqli_query($conn, $querya7);
        } else if ($taxtype == "I") {
            $querya7 = "call acc_sp_insdbcrnotetrailernew('$gindbcrseq','$slno','',curdate(),'$totalval','$compcode','$dnnew','$TAXVALnew','0','0');";
            $resulta7 = mysqli_query($conn, $querya7);
        }
    }
    $slno = $slno + 1;
...
#Insert AccTrail for Debit Ledger
    ...
    if ($Qty > 0) {
        ...
        $resultupd = mysqli_query($conn, $querytupd);
    }
}
