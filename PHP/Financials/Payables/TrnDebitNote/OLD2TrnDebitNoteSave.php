    ...
    if ($output == "N") {
        if ($compcode == 1) {
            if ($TAXVAL > 0) {
                if ($taxtype == "CS") {
                    $TAXVAL = $TAXVAL / 2;
                    $queryatax = "call acc_sp_trn_insacc_tran('$ginaccrefseq',3,'33201',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
                    $resultatax = mysqli_query($conn, $queryatax);

                    $queryatax2 = "call acc_sp_trn_insacc_tran('$ginaccrefseq',4,'33202',0,'$TAXVAL','$TAXVAL',1,0,0,'','$paytype');";
