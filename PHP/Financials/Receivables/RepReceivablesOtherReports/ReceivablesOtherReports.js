...
var optRpttype = new Ext.form.FieldSet({
    ...
    items: [
    {
        ...
        id: 'optRpttype',
        items: [
		{boxLabel: 'AR - Register', name: 'optRpttype', id:'optARregister', inputValue: 1,checked:false,
			listeners:{
...
{
        window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/RepAccReceivablesAgewise.rptdesign' + param,  '_blank' );                            
}
