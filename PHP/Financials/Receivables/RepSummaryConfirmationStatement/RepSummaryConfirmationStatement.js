Ext.onReady(function () {
    ...
    var LoadledgernameDatastore = new Ext.data.Store({
      ...
      proxy: new Ext.data.HttpProxy({
            ...
            baseParams:{task:"loadledgergroupname",repoption:"G"}, // this parameter asks for listing
...
var FlxLedgerdetails = new Ext.grid.EditorGridPanel({
    ...
    var CommonReportsFormPannel = new Ext.FormPanel({
        renderTo: Ext.getBody(),
        xtype: 'form',
        title: 'Summary/Confirmation/Statement of Accounts', bodyStyle: {"background-color": "WHITE"},
        width: 660,
        height: 500,
        x: 25,
        y: 25,
        ...
        items: [
                ...
                items: [
                    {
                        ...
                        columns: 3,
                        items: [
                     {boxLabel: 'Expenses Summary', name: 'reportoption', inputValue: '1',  id: 'optexpsum',checked:true,listeners:{
               		check:function(rb,checked){
                		if(checked==true){
		               
		         	}
               		}}},
                            {boxLabel: 'Confirmation of Bal', name: 'reportoption', inputValue: '2', id: 'optbalcon',listeners:{
               		check:function(rb,checked){
                		if(checked==true){
		               
		         	}
               		}}},
               		{boxLabel: 'Statement of A/C', name: 'reportoption', inputValue: '2', id: 'optstaac',listeners:{
               		check:function(rb,checked){
                		if(checked==true){
            ...
            },
            {
                ...
                items: [
                        ...
                        columns: 3,
                        items: [
                            {boxLabel: 'Groupwise', name: 'selopt', inputValue: '1',  id: 'optgrpwise',checked:true,listeners:{
               		check:function(rb,checked){
                		if(checked==true){
		                optval = "G";
		                 ...
		                 params:
		                  {
		                    task:"loadledgergroupname",
		                    repoption:optval
		                   }
                     });
		         	}
               		}}},
                            {boxLabel: 'Ledgerwise', name: 'selopt', inputValue: '2', id: 'optledwise',listeners:{
               		check:function(rb,checked){
                		if(checked==true){
		            	optval = "L";
    ...
    var CommonReportsFormWindow = new Ext.Window({
        height: 425,
        width: 480,
