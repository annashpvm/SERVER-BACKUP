   ...
   var fp = new Ext.FormPanel({
	...
	tbar: {
		...
		var param = (fd + td + c + f + g) ; 
		     	if (rd=="1")
		     	{    
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepDebitNotePrinting.rptdesign' + param,  '_blank' );   	
		     	}
			else
			{
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepDebitNotePrintingAc.rptdesign' + param,  '_blank' );   
			}
 }}
                 },'-',
                {
