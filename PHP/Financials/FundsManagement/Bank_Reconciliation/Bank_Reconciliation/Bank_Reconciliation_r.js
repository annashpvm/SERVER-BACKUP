  ...
  listeners: {
    ...
    var Datagridd = new Ext.grid.EditorGridPanel({
        ...
        listeners: {
			...
			var selected_rows2 = Datagridd.getSelectionModel().selectRow();
			...
			tempdebt += parseFloat(selected_rows2[i].data.acctran_dbamt);
                    	tempcrr += parseFloat(selected_rows2[i].data.acctran_cramt);
