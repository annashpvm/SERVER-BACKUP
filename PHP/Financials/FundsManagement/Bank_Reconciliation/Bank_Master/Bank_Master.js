...
Ext.onReady(function () {
            ...
            fn: function (btn) {
                if (btn === 'yes') {
                    ...
                    FormPanel.getForm().submit({
                        url: '/SHVPM/Financials/FundsManagement/Bank_Reconciliation/Bank_Master/Bank_Master_Save.php',
                        method: 'POST',
                        //Ext.Ajax.request({
                        //     url: '/SHVPM/Financials/Bank_Master/Bank_Master_Save.php',
                        params: {
			    ...
			    cclimit: txtcclimit.getRawValue(),
                            status: 'Y',
                            userid: loginid
                        },
                        success: function () {
 ...
 var txtcclimit = new Ext.form.NumberField({
        labelSeparator: "",
        fieldLabel: 'CC limit',
        id: 'txtcclimit',
        name: 'txtcclimit',
    ...
    var gridView = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'total',
            id: 'id'
        }, ['bank_code', 'bank_name', 'branch_name', 'account_no', 'value_month', 'month_name', 'value_year', 'closing_balance_bankstatement', 'closing_balance_kgdlbankbook','cc_limit', 'active_status'])
    ...
    var Datagridd = new Ext.grid.EditorGridPanel({
        ...
        columns: [
 	    ...
 	    {header: "CC limit", dataIndex: 'cc_limit', sortable: true, width: 70, align: 'left'},
		...
		txtcclimit.setRawValue(val10);

     		/*var data11 = Datagrid.getStore().getAt(rowIndex);
                var column11 = Datagrid.getColumnModel().getDataIndex(10);
                var val11 = data11.get(column11);*/
