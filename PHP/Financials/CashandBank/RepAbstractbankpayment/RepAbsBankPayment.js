            ...
            items: [
...

                {
                    ...
                    var td = "&todate="+encodeURIComponent(d2);
                     ...
                     if(gstledcode=='')
                     {
                     window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepBankAbstractPayment.rptdesign'+test,  '_blank' );
                     }
                     if(gstledcode!='')
                     {
                      window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepBankPaymentPartywise.rptdesign'+test,  '_blank' );
                     }
                    }
                    }
                    }
