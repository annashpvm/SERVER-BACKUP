...
for ($i = 0; $i < $rowcnt; $i++) {
    ...
    if ($adjamt > 0) {
		...
		$resultrefchkrecp = mysqli_query($conn, $queryrefchkrecp);
		$recrefchkrecp = mysqli_fetch_array($resultrefchkrecp);
        ...
        if ($voutype == "SE") {
            ...
            $rec1 = mysqli_fetch_array($result2);
            ...
            $rec2 = mysqli_fetch_array($result3);
            $slno = $rec2['slno'];
            ...
            $rec3 = mysqli_fetch_array($result4);
