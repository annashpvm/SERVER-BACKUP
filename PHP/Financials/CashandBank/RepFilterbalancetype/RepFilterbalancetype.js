...
var todate = new Ext.form.DateField({
   ...
   var fp = new Ext.FormPanel({
	...
	tbar: {
			...
			if (type=="All Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepBalTypeAll.rptdesign' + param, '_blank'); 
			}
			else if (type=="Credit Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepBalTypeCramt.rptdesign' + param, '_blank'); 
			}
			else if (type=="Debit Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepBalTypeDbamt.rptdesign' + param, '_blank'); 
			}
			else
			{
			...
			if (type=="All Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepAbstractLedger.rptdesign' + param, '_blank'); 
			}
			else if (type=="Credit Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepAbstractLedgerCredit.rptdesign' + param, '_blank'); 
			}
			else if (type=="Debit Balance")
			{
window.open('http://denimsoft.kgdenim.com:8080/birt-viewer/frameset?__report=accounts/AccRepAbstractLedgerDebit.rptdesign' + param, '_blank'); 
			}
			else
			{
                          Ext.MessageBox.alert("Alert","Select the Type of Balance...");
