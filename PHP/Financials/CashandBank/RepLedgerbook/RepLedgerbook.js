...
var todate = new Ext.form.DateField({
   ...
   var fp = new Ext.FormPanel({
        ...
        title       : 'LEDGER BOOK',
        width       : 420,
        height      : 400,        bodyStyle:{"background-color":"#3399CC"},
        x           : 25,
        y           : 25,
        frame       : false,
        id          : 'fp',
...
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingAmountwise.rptdesign' + param, '_blank');
			...
			{
				if (chkled=="1")
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingStoresLedger.rptdesign' + param, '_blank');	
				else{
//window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingDatewise.rptdesign' + param, '_blank');
//window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingDatewisenew.rptdesign' + paramnew, '_blank');
			var paramnew=(led + com + fin + fd + td + lename) ;

window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingDatewise.rptdesign' + paramnew, '_blank');
}
			}
			else
window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingDatewisenew.rptdesign' + paramnew, '_blank');
//window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/AccRepBookPrintingrep1.rptdesign' + param, '_blank');	
...
border  :  false,
                ...
                items: [
                    ...
                    {boxLabel: 'Select', name: 'optled', inputValue: '2',listeners:{
               		check:function(rb,checked){
                		if(checked==true){
