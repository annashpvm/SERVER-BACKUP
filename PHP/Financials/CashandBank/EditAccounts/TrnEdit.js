Ext.onReady(function () {
    ...
    var TrailBills2DataStore = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '/SHVPM/Financials/class.php', // File to connect to
            method: 'POST'
        }),
        ...
        listeners: {
            keyup: function () {
                if (txtpass.getRawValue() === "smis") {
                    ...
                    txtVocherNo.focus();
                } else if (txtpass.getRawValue() === "prmis") {
                    flxTran.show();
                    flxRef.show();
                    flxTrail.show();
                    flxRefbills.show();
                    ...
                    txtVocherNo.setRawValue();
                    txtVocherNo.focus();
                } else if (txtpass.getRawValue() === "pramis") {
                    flxTran.show();
                    flxRef.show();
                    flxTrail.show();
                    flxRefbills.show();
                    ...
                    txtVocherNo.setRawValue();
                    txtVocherNo.focus();
                } else if (txtpass.getRawValue() === "inmis") {
                    flxTran.show();
                    flxRef.show();
                    flxTrail.show();
                    flxRefbills.show();
                    ...
                    txtVocherNo.setRawValue();
                    txtVocherNo.focus();
                } else if (txtpass.getRawValue() === "asmis") {
                    flxTran.show();
                    flxRef.show();
                    flxTrail.show();
                    flxRefbills.show();
                    ...
                    txtVocherNo.setRawValue();
                    txtVocherNo.focus();
                } else if (txtpass.getRawValue() === "ssmis") {
                    flxTran.show();
                    flxRef.show();
                    flxTrail.show();
                    flxRefbills.show();
    ...
    function load() {
        ...
        VouNoDataStore.load({
            url: '/SHVPM/Financials/class.php',
            params: {
                task: 'VouNo',
                comp: compcode,
                finid: GinFinid,
...
alert(cnt);
                if (cnt > 0) {
                    ...
                    for (var i = 0; i < cnt; i++) {
                        if (VouNoDataStore.getAt(i).get('accref_comp_code') == 90) {
                            ...
                            compcodenew = "DANALAKSHMI PAPER MILLS PRIVET LIMITED";
                        } else if (VouNoDataStore.getAt(i).get('accref_comp_code') == 2) {
                            compcodenew = "VIJAYALAKSHMI PAPER MILLS";
                        }
                        if (VouNoDataStore.getAt(i).get('accref_finid') == 20) {
                            finyear = "2020-2021";
                        } else if (VouNoDataStore.getAt(i).get('accref_finid') == 21) {
                            finyear = "2021-2022";
                        } else if (VouNoDataStore.getAt(i).get('accref_finid') == 22) {
                            finyear = "2022-2023";
                        } else if (VouNoDataStore.getAt(i).get('accref_finid') == 23) {
                            finyear = "2023-2024";
                        }
                          ...
                          //  if (cnt > 0) {
                                for (var i = 0; i < cnt; i++) {
                                    if (TrailDataStore.getAt(i).get('acctrail_adj_value') > 0) {
                                        Ext.getCmp('tiltie').setText('Voucher Already Make Adjust!');
                                    }
                                    flxTrail.getStore().insert(
                                            ...
                                            new dgrecord({
                                                ...
                                                led_name: TrailDataStore.getAt(i).get('led_name')
                                            }));
                                }
                                TranDataStore.load({
                                    url: '/SHVPM/Financials/class.php',
                                            ...
                                            for (var i = 0; i < cnt; i++) {
                                                flxTran.getStore().insert(
                                                        ...
                                                        new dgrecord({
                                                            ...
                                                            led_name: TranDataStore.getAt(i).get('led_name'),
    ...
    var flxRef = new Ext.grid.EditorGridPanel({
        ...
        columns: [
            ...
            {header: "Seqno", dataIndex: 'accref_seqno', sortable: true, width: 100, align: 'left'},
            {header: "VouNo", dataIndex: 'accref_vouno', sortable: true, width: 100, align: 'left'},
            {header: "Company", dataIndex: 'accref_comp_code', sortable: true, width: 100, align: 'left'},
            {header: "Finyear", dataIndex: 'accref_finid', sortable: true, width: 100, align: 'left'},
            {header: "VouDate", dataIndex: 'accref_voudate', sortable: true, width: 100, align: 'left',
                editor: {
                    xtype: 'textfield',
                    allowBlank: true,
                    enableKeyEvents: true
    ...
    var flxTran = new Ext.grid.EditorGridPanel({
        ...
        y: 125,
        columns: [
            {header: "Table", dataIndex: 'Tran', sortable: true, width: 80, align: 'left'},
            {header: "Seqno", dataIndex: 'acctran_accref_seqno', sortable: true, width: 100, align: 'left'},
            {header: "Sno", dataIndex: 'acctran_serialno', sortable: true, width: 100, align: 'left', editor: {
                    xtype: 'textfield',
                    allowBlank: true,
                    enableKeyEvents: true
                }},
            {header: "Ledcode", dataIndex: 'acctran_led_code', sortable: true, width: 100, align: 'left'},
            {header: "LedName", dataIndex: 'led_name', sortable: true, width: 250, align: 'left',
                    ...
                    listeners: {
                        keyup: function () {
                            ...
                            LedAgsDataStore.load({
                                ...
                                callback: function () {
                                    lednewcode = LedAgsDataStore.getAt(0).get('led_code');
            ...
            {header: "Debit", dataIndex: 'acctran_dbamt', sortable: true, width: 100, align: 'left',
                editor: {
                    xtype: 'numberfield',
                    allowBlank: false,
                    enableKeyEvents: true,
            ...
            {header: "Credit", dataIndex: 'acctran_cramt', sortable: true, width: 100, align: 'left',
                editor: {
                    xtype: 'numberfield',
                    allowBlank: false,
                    enableKeyEvents: true,
            ...
            {header: "TotAmt", dataIndex: 'acctran_totamt', sortable: true, width: 100, align: 'left'},
    ...
    var flxTrail = new Ext.grid.EditorGridPanel({
        ...
        columns: [
            ...
            {header: "SerialNo", dataIndex: 'acctrail_serialno', sortable: true, width: 100, align: 'left', editor: {
                    xtype: 'textfield',
                    allowBlank: true,
                    enableKeyEvents: true
                }},
            ...
            {header: "InvNo", dataIndex: 'acctrail_inv_no', sortable: true, width: 100, align: 'left', editor: {
                    xtype: 'textfield',
                    allowBlank: true,
                    enableKeyEvents: true
                }},
            ...
            {header: "InvValue", dataIndex: 'acctrail_inv_value', sortable: true, width: 100, align: 'left',
                editor: {
                    xtype: 'numberfield',
                    allowBlank: true,
                    enableKeyEvents: true
                }},
            {header: "AdjuseVal", dataIndex: 'acctrail_adj_value', sortable: true, width: 100, align: 'left',
                editor: {
                    xtype: 'numberfield',
                    allowBlank: true,
                    enableKeyEvents: true
                }, },
            {header: "Ledcode", dataIndex: 'acctrail_led_code', sortable: true, width: 100, align: 'left'}
        ],
        store: []
    });
    ...
    var cmbApprove = new Ext.form.ComboBox({
        ...
        width: 150,
        store: ['MUTHUSAMY', 'MANNIKAM', 'SAKTHIVEL', 'RANGARAJ', 'RAGHU', 'NAVEEN', 'GOPINATH', 'RAMSRINIVASN', 'MURALI','VIJAYAKUMAR','MIS','GEETHA'],
    ...
    var cmbRequest = new Ext.form.ComboBox({
        ...
        width: 150,
        store: ['GEETHA', 'SAKTHIVEL', 'GOMATHI', 'SUMATHI ACCOUNTS', 'RAJESH', 'CHANDRA SEKAR', 'JESSI', 'DHLIP', 'RAGHU', 'DINAKARAN', 'SANKAR NARAYANAN', 'PATHI', 'MANOKAR', 'MURALI', 'SUMITH LOGISTICS', 'VELUMANI','NALINI DEVI','ARUN','MIS','SATHYANARAYANAN','POWERPLANT BOOBATHI','VELUMANI','SANMUGAM','VINU'],
    ...
    var EntryFormPanel = new Ext.FormPanel({
        ...
        tbar: {
            ...
            items: [
			  ...
			  if(cmbApprove.getRawValue()===""){
                                    ...
                                    callback: function () {
                                        ...
                                        if (cnt > 0) {
                                            ...
                                            if (trancnt > 0 && refcnt > 0 && trailcnt > 0) {
                                                ...
                                                Ext.Ajax.request({
                                                    url: '/SHVPM/Financials/CashandBank/EditAccounts/EditSave.php',
                                                    params: {
                ...
                {
                    text: 'DATE',
                    style: 'text-align:center;', style: 'background-color: white;',
                            height: 40,
                    fontSize: 30,
                    width: 70,
                    listeners: {
                        click: function () {
                            window.location.href = ('/SHVPM/Financials/Payables/DATE/DATE.php');
                        }
                    }
                }, {
                    text: '',
        ...
        items: [
            ...
            }, flxRef, flxTran, flxTrail, flxRefbills, flxRefbills2,
        ]
    });
