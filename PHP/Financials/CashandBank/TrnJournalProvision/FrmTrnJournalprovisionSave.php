<?php
    ...
    $compcode = $_REQUEST['compcode'];
        ...
        $query2 = "select ifnull(max(convert(substring(accref_vouno,3),signed)),0) +1 as vou_no from accrefprovision where  accref_finid = '$finid' and accref_comp_code = '$compcode';";
