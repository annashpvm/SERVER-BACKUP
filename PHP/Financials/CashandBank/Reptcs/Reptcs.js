   ...
   var fp = new Ext.FormPanel({
	...
	tbar: {
			...
			var d2 =  tdate + " 00:00:00.000";
                        ...
                        var tfi = "&finid="+encodeURIComponent(GinFinid);

			var param = (fd + td + tfi) ;

			window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/tcsbook.rptdesign' + param, '_blank');			
			...
			window.open('http://192.168.11.14:8080/birt/frameset?__report=accounts/tcsbook2.rptdesign' + param, '_blank');			
