...
Ext.onReady(function () {
    ...
    var gstcompcode = localStorage.getItem('gincompcode');
...
//alert(ledtype);
    ...
    var flxAdjustDetails = new Ext.grid.EditorGridPanel({
        ...
        columns: [
            ...
            {header: "Inv.Amount", dataIndex: 'InvAmt', sortable: true, width: 105, align: 'left'},
            {header: "DN/CN", dataIndex: 'DNCN', sortable: true, width: 75, align: 'left'},
                            ...
                            CheckNoValidateDataStore.load({
                                ...
                                callback: function () {
                                    ...
                                    if (cntnew <= 0) {
                                        ...
                                        } /*else if ((txtmodeNo.getRawValue() <= 0 || txtmodeNo.getRawValue() === '') && (cmbPaymode.getRawValue() === 'CQ')) {
                                            Ext.MessageBox.alert("Payment", "Enter Check No !");
                                        } */else {
                                            Ext.MessageBox.show({
                                                title: 'Confirmation',
                                                icon: Ext.Msg.QUESTION,
