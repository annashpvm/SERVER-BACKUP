...
<head>
    ...
    <script type="text/javascript" src="sdownload.js"></script>
    <script type="text/javascript" src="/DPM/Financials/CashBankMenus.js"></script>
   <?php
    require($_SERVER["DOCUMENT_ROOT"]."/DPM/Financials/FinancialsMainPage.php");
   ?>
