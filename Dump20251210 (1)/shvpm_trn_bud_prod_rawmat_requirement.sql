...
--
-- Table structure for table `trn_bud_prod_rawmat_requirement`
--

DROP TABLE IF EXISTS `trn_bud_prod_rawmat_requirement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_bud_prod_rawmat_requirement` (
  `bud_compcode` tinyint NOT NULL,
  `bud_fincode` tinyint NOT NULL,
  `bud_month` int NOT NULL,
  `bud_year` int NOT NULL,
  `bud_rmcode` int NOT NULL,
  `bud_rate` int DEFAULT NULL,
  ...
  `bud_tot_qty_req` decimal(8,3) DEFAULT NULL,
  `stock` decimal(7,3) DEFAULT NULL,
  `bud_v11_ordqty` decimal(5,1) DEFAULT NULL,
  `bud_v11_qty_pmt` decimal(5,1) DEFAULT NULL,
  `bud_v11_qty_req` decimal(5,1) DEFAULT NULL,
  `bud_v12_ordqty` decimal(5,1) DEFAULT NULL,
  `bud_v12_qty_pmt` decimal(5,1) DEFAULT NULL,
  `bud_v12_qty_req` decimal(5,1) DEFAULT NULL,
  `bud_v13_ordqty` decimal(5,1) DEFAULT NULL,
  `bud_v13_qty_pmt` decimal(5,1) DEFAULT NULL,
  `bud_v13_qty_req` decimal(5,1) DEFAULT NULL,
  `bud_v14_ordqty` decimal(5,1) DEFAULT NULL,
  `bud_v14_qty_pmt` decimal(5,1) DEFAULT NULL,
  `bud_v14_qty_req` decimal(5,1) DEFAULT NULL,
  `bud_v15_ordqty` decimal(5,1) DEFAULT NULL,
  `bud_v15_qty_pmt` decimal(5,1) DEFAULT NULL,
  `bud_v15_qty_req` decimal(5,1) DEFAULT NULL,
  ...
  PRIMARY KEY (`bud_compcode`,`bud_fincode`,`bud_year`,`bud_month`,`bud_rmcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trn_bud_prod_rawmat_requirement`
--

LOCK TABLES `trn_bud_prod_rawmat_requirement` WRITE;
/*!40000 ALTER TABLE `trn_bud_prod_rawmat_requirement` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_bud_prod_rawmat_requirement` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-10 11:46:44
