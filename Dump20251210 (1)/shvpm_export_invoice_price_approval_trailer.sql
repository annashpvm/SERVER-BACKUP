...
--
-- Table structure for table `export_invoice_price_approval_trailer`
--

DROP TABLE IF EXISTS `export_invoice_price_approval_trailer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `export_invoice_price_approval_trailer` (
  ...
  `ei_qty` decimal(7,3) DEFAULT NULL,
  ...
  `ei_close` varchar(1) DEFAULT NULL,
  `ei_varcode2` decimal(6,0) DEFAULT NULL,
  `ei_gsm` decimal(5,1) DEFAULT NULL,
  `ei_color` varchar(10) DEFAULT NULL,
  `cancelflag` decimal(9,5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `export_invoice_price_approval_trailer`
--

LOCK TABLES `export_invoice_price_approval_trailer` WRITE;
/*!40000 ALTER TABLE `export_invoice_price_approval_trailer` DISABLE KEYS */;
/*!40000 ALTER TABLE `export_invoice_price_approval_trailer` ENABLE KEYS */;
UNLOCK TABLES;
