...
--
-- Table structure for table `rep_collection_ret`
--

DROP TABLE IF EXISTS `rep_collection_ret`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rep_collection_ret` (
  `recptno` int NOT NULL,
...
--
-- Dumping data for table `rep_collection_ret`
--

LOCK TABLES `rep_collection_ret` WRITE;
/*!40000 ALTER TABLE `rep_collection_ret` DISABLE KEYS */;
/*!40000 ALTER TABLE `rep_collection_ret` ENABLE KEYS */;
UNLOCK TABLES;
