...
--
-- Table structure for table `trn_prodplan_trailer_amend`
--

DROP TABLE IF EXISTS `trn_prodplan_trailer_amend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_prodplan_trailer_amend` (
...
--
-- Dumping data for table `trn_prodplan_trailer_amend`
--

LOCK TABLES `trn_prodplan_trailer_amend` WRITE;
/*!40000 ALTER TABLE `trn_prodplan_trailer_amend` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_prodplan_trailer_amend` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-10 11:47:08
