...
--
-- Table structure for table `trn_bud_prod_chemical_requirement`
--

DROP TABLE IF EXISTS `trn_bud_prod_chemical_requirement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_bud_prod_chemical_requirement` (
  `bud_compcode` tinyint NOT NULL,
  `bud_fincode` tinyint NOT NULL,
  `bud_month` int NOT NULL,
  `bud_year` int NOT NULL,
  `bud_chemicode` int DEFAULT NULL,
  ...
  `bud_v15_qty_req` decimal(10,3) DEFAULT NULL,
  ...
  PRIMARY KEY (`bud_compcode`,`bud_fincode`,`bud_month`,`bud_year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trn_bud_prod_chemical_requirement`
--

LOCK TABLES `trn_bud_prod_chemical_requirement` WRITE;
/*!40000 ALTER TABLE `trn_bud_prod_chemical_requirement` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_bud_prod_chemical_requirement` ENABLE KEYS */;
UNLOCK TABLES;
