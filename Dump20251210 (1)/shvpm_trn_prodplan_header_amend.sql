...
--
-- Table structure for table `trn_prodplan_header_amend`
--

DROP TABLE IF EXISTS `trn_prodplan_header_amend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_prodplan_header_amend` (
  `pp_comp_code` tinyint NOT NULL,
  `pp_fincode` tinyint NOT NULL,
  `pp_amendno` smallint NOT NULL,
  `pp_amenddate` datetime NOT NULL,
  ...
  `pp_machine` char(1) DEFAULT NULL,
  `pp_closereason` varchar(50) DEFAULT NULL,
  `ma_order_ref` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `trn_prodplan_header_amend`
--

LOCK TABLES `trn_prodplan_header_amend` WRITE;
/*!40000 ALTER TABLE `trn_prodplan_header_amend` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_prodplan_header_amend` ENABLE KEYS */;
UNLOCK TABLES;
