...
--
-- Table structure for table `trnfu_receipt_handling`
--

DROP TABLE IF EXISTS `trnfu_receipt_handling`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trnfu_receipt_handling` (
  ...
  `rech_ledcode` int NOT NULL,
  `rech_amount` decimal(10,2) DEFAULT NULL,
  `rech_accupd` char(1) DEFAULT NULL,
  `rech_pfvouno` varchar(12) DEFAULT NULL,
  `rech_pcvouno` varchar(12) DEFAULT NULL,
  `rech_pcvoudate` datetime DEFAULT NULL,
  ...
  `rech_cess_amt` decimal(8,2) DEFAULT NULL,
  `rech_partybillno` varchar(20) DEFAULT NULL,
  ...
  `rech_truck` varchar(20) NOT NULL,
  ...
  PRIMARY KEY (`rech_compcode`,`rech_fincode`,`rech_grnno`,`rech_ledcode`,`rech_ledtype`,`rech_truck`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trnfu_receipt_handling`
--

LOCK TABLES `trnfu_receipt_handling` WRITE;
/*!40000 ALTER TABLE `trnfu_receipt_handling` DISABLE KEYS */;
/*!40000 ALTER TABLE `trnfu_receipt_handling` ENABLE KEYS */;
UNLOCK TABLES;
