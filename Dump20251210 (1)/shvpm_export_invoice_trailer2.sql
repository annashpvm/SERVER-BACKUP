...
--
-- Table structure for table `export_invoice_trailer2`
--

DROP TABLE IF EXISTS `export_invoice_trailer2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `export_invoice_trailer2` (
...
--
-- Dumping data for table `export_invoice_trailer2`
--

LOCK TABLES `export_invoice_trailer2` WRITE;
/*!40000 ALTER TABLE `export_invoice_trailer2` DISABLE KEYS */;
/*!40000 ALTER TABLE `export_invoice_trailer2` ENABLE KEYS */;
UNLOCK TABLES;
