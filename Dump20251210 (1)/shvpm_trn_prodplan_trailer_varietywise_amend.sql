...
--
-- Table structure for table `trn_prodplan_trailer_varietywise_amend`
--

DROP TABLE IF EXISTS `trn_prodplan_trailer_varietywise_amend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_prodplan_trailer_varietywise_amend` (
  `pih_comp_code` tinyint NOT NULL,
  `pih_fincode` tinyint NOT NULL,
  `pih_machine` smallint NOT NULL,
  `pih_amendno` smallint NOT NULL,
  `pih_amenddate` datetime NOT NULL,
  `pih_mano` int NOT NULL,
...
--
-- Dumping data for table `trn_prodplan_trailer_varietywise_amend`
--

LOCK TABLES `trn_prodplan_trailer_varietywise_amend` WRITE;
/*!40000 ALTER TABLE `trn_prodplan_trailer_varietywise_amend` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_prodplan_trailer_varietywise_amend` ENABLE KEYS */;
UNLOCK TABLES;
